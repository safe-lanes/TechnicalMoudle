...
const FIELD_MAPPINGS = [
  ...
  { field: "Serial Number", required: false, description: "Serial number template" },
  ...
  { field: "Is Running Hours", required: false, description: "Yes/No - tracks running hours" },
  { field: "Description", required: false, description: "Technical description" },
...
export default function FleetComponentUpload() {
  ...
  const handleDownloadTemplate = async () => {
    try {
      ...
      a.href = url;
      a.download = 'Fleet_Component_Template.xlsx';
      ...
      toast({
        ...
        description: 'Fleet Component template has been downloaded.'
      });
    } catch (error) {
      toast({
  ...
  const handleUpload = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: 'Fleet Component data has been imported successfully.'
      });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Fleet Component Upload</h1>
          <p className="text-gray-600 mt-1">Bulk import Fleet Component templates via CSV or Excel files</p>
        </div>
        ...
        <TabsContent value="upload" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload CSV, XLS, or XLSX files containing fleet component data</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div 
                ...
                onClick={() => document.getElementById('fleet-comp-file-input')?.click()}
              >
                <Input
                  id="fleet-comp-file-input"
                  type="file"
                  accept=".csv,.xls,.xlsx"
        ...
        <TabsContent value="mapping">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Reference for all available fields in the Fleet Component template</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
        ...
        <TabsContent value="history">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Previous uploads for Fleet Component data</CardDescription>
            </CardHeader>
            <CardContent>
