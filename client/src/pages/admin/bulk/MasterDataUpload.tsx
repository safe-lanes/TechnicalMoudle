...
const FIELD_MAPPINGS = [
  ...
  { field: "Maker Code", required: true, description: "Must match Maker List" },
  { field: "Category", required: false, description: "Equipment category" },
...
export default function MasterDataUpload() {
  ...
  const handleDownloadTemplate = () => {
    toast({
      ...
      description: 'Master Data template has been downloaded.'
    });
  };
  ...
  const handleUpload = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: 'Master Data has been imported successfully.'
      });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Master Data Upload</h1>
          <p className="text-gray-600 mt-1">Bulk import Fleet Equipment Models via CSV or Excel files</p>
        </div>
        ...
        <TabsContent value="upload" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload CSV, XLS, or XLSX files containing fleet equipment data</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="mapping">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Reference for all available fields in the Master Data template</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
        ...
        <TabsContent value="history">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Previous uploads for Master Data</CardDescription>
            </CardHeader>
            <CardContent>
