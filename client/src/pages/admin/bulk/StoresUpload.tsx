...
const FIELD_MAPPINGS = [
  { field: "Item Code",        required: true,  description: "Unique identifier per vessel" },
  ...
  { field: "Category",         required: false, description: "Category (General Stores, Electrical, Deck, etc.)" },
...
export default function StoresUpload({ vesselId, markers }: StoresUploadProps) {
  ...
  return (
    <UniformBulkUpload
      ...
      vesselId={vesselId}
      previewColumns={["Item Code", "Item Name", "Category"]}
