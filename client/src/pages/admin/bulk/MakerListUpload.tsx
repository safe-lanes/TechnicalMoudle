...
import { Download, Upload, CheckCircle, AlertTriangle, AlertCircle, Clock, FileSpreadsheet } from "lucide-react";
...
const FIELD_MAPPINGS = [
  ...
  { field: "Contact Person", required: false, description: "Primary contact name" },
  { field: "Email", required: false, description: "Contact email address" },
  { field: "Phone", required: false, description: "Contact phone number" },
  { field: "Website", required: false, description: "Manufacturer website URL" },
  { field: "Country", required: false, description: "Country of origin" },
  { field: "Notes", required: false, description: "Additional notes or remarks" },
...
export default function MakerListUpload() {
  ...
  const handleDownloadTemplate = () => {
    toast({
      ...
      description: 'Maker List template has been downloaded.'
    });
  };
  ...
  const handleUpload = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: 'Maker data has been imported successfully.'
      });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Maker List Upload</h1>
          <p className="text-gray-600 mt-1">Bulk import Maker Details via CSV or Excel files</p>
        </div>
        ...
        <TabsContent value="upload" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload CSV, XLS, or XLSX files containing maker/manufacturer data</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="mapping">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Reference for all available fields in the Maker List template</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
        ...
        <TabsContent value="history">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Previous uploads for Maker List data</CardDescription>
            </CardHeader>
            <CardContent>
