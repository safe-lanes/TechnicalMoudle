...
interface ComplianceReportListGridProps {
...
const ComplianceReportListGrid: React.FC<ComplianceReportListGridProps> = ({
  ...
  const columns: ReportColumn[] = useMemo(() => [
    {
      ...
      cellRenderer: (p: any) => (
        <div data-testid={`compliance-report-row-${p.data.id}`}>
    ...
    },
    {
      ...
      cellRenderer: (p: any) => {
        const r: ComplianceReport = p.data;
        return (
  ...
  return (
    <ReportAgGridTable
      ...
      headerHeight={42}
      rowHeight={64}
      testId="grid-compliance-reports-list"
