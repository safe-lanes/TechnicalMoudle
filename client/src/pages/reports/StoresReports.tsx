...
interface StoresReportListGridProps {
  reports: StoresReport[];
...
const STORES_DETAIL_REPORT_IDS = new Set(['stores-inventory-status', 'chemicals-tracking', 'low-stock-alert', 'stores-consumption-analysis']);
