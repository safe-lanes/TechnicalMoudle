...
const MaintenanceReports: React.FC<MaintenanceReportsProps> = ({ onBack, globalFilters, embedded, selectedReportId }) => {
      ...
      {embedded && previewData && (
        <div className="mt-6 border border-gray-200 rounded-lg p-4 bg-gray-50">
          <div className="flex items-center justify-between mb-3">
            ...
            <Button variant="ghost" size="sm" onClick={() => { setPreviewOpen(false); setPreviewData(null); }}>
              Close Preview
            </Button>
          </div>
