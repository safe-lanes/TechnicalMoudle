...
interface MaintenanceReportListGridProps {
...
const MaintenanceReportListGrid: React.FC<MaintenanceReportListGridProps> = ({
  ...
  const columns: ReportColumn[] = useMemo(() => [
    {
      ...
      cellRenderer: (p: any) => (
        <div data-testid={`maintenance-report-row-${p.data.id}`}>
    ...
    },
    {
      ...
      cellRenderer: (p: any) => {
        const r: MaintenanceReport = p.data;
        return (
  ...
  return (
    <ReportAgGridTable
      ...
      headerHeight={42}
      rowHeight={64}
      testId="grid-maintenance-reports-list"
