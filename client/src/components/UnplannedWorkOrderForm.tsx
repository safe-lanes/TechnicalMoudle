  ...
  const handleSubmit = async () => {
    ...
    if (onSubmit) {
      ...
      try {
        ...
        // Note: schema uses 'component' (not 'componentId'), 'workOrderNo' is auto-generated by backend
        const workOrderPayload = {
          vesselId: vesselId,
          component: formData.componentId, // Use componentId as the component field value
