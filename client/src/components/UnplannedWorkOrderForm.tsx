  ...
  const handleSubmit = async () => {
    ...
    if (onSubmit) {
      ...
      try {
        ...
        // Note: schema uses 'component' for display name (not 'componentId'), 'workOrderNo' is auto-generated by backend
        const workOrderPayload = {
          vesselId: vesselId,
          component: formData.componentName, // Use componentName for display in Work Orders list
          componentCode: formData.componentCode,
          jobTitle: formData.jobTitle,
          workOrderType: 'Unplanned',
          maintenanceType: formData.maintenanceType || 'Unplanned Maintenance',
          assignedTo: formData.assignedTo || 'Chief Engineer', // Default if not selected
