...
export function applyStandardHeader(
  ...
  // Row 5: Report Period / Generated By & Total Records
  const row5LeftText = reportPeriod 
    ? `Report Period: ${reportPeriod}  |  Generated By: PMS System`
    : 'Generated By: PMS System';
  worksheet.getCell('A5').value = row5LeftText;
  worksheet.getCell('A5').font = { size: 9, bold: !!reportPeriod, color: { argb: reportPeriod ? COLORS.textDark : COLORS.textLight }, name: 'Arial' };
