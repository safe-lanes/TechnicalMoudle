...
export class PersistentFileStorage implements IStorage {
    ...
    const seedWorkOrders: WorkOrder[] = [
      {
        ...
        safetyChecklistsStatus: null,
        operationalFormsStatus: null,
        startDateTime: null,
        completionDateTime: null,
        executionAssignedTo: null,
        performedBy: null,
        noOfPersons: null,
        totalTimeHours: null,
        manhours: null,
        workCarriedOut: null,
        jobExperienceNotes: null,
        previousReading: null,
        runningHours: null,
        runningHoursDifference: null,
        readingDate: null,
        woExecutionId: null,
        remarks: null,
  ...
  async getComponents(vesselId?: string): Promise<Component[]> {
    ...
    // Return components with their own RH values only
    // Delta propagation is handled by cascadeRunningHours - children maintain their own independent RH
    // that gets incremented by parent's delta when parent RH is updated
    return filtered;
  }
