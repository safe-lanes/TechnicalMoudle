...
moduleRouter.use(retentionRoutes);
...
moduleRouter.use(approvalNotificationRoutes);
moduleRouter.use(devTestUsersRoutes); // approval notifications inbox (Phase 2 follow-up)
// ====== NOON REPORT MODULE — END ======
