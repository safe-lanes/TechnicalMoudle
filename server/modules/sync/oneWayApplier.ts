...
export async function applyOneWayRows(
  ...
  const COMPOSITE_KEY_TABLES: Record<string, string[]> = {
    ...
    // RBAC permissions — id is GENERATED ALWAYS, UNIQUE on (role_ruid, menu_muid)
    adm_role_menu_access: ['role_ruid', 'menu_muid'],
    // Vessel department config — id is GENERATED BY DEFAULT, UNIQUE on (vessel_id, department)
