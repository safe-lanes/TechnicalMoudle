...
router.get('/reports/class-items-jobs', asyncHandler(equipCtrl.getClassItemsJobsStatus));
...
router.get('/reports/maintenance/wo-overview/preview', asyncHandler(maintCtrl.getWorkOrderOverviewPreview));
router.post('/reports/maintenance/wo-overview/excel', asyncHandler(maintCtrl.exportWorkOrderOverview));
