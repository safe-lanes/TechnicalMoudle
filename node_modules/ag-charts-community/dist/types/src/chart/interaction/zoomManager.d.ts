...
export declare class ZoomManager extends BaseManager {
    ...
    updateAxes(nextAxes: Array<ChartAxisLike | CartesianAxisDirection>): void;
    ...
    constrainZoomToItemCount(zoom: DefinedZoomState, minVisibleItems: number): DefinedZoomState | undefined;
