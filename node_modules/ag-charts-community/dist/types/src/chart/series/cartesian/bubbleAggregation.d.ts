...
export declare function aggregateBubbleData(xScale: ScaleType, yScale: ScaleType, xValues: any[], yValues: any[], sizeValues: any[] | undefined, xDomain: any[], yDomain: any[], sizeDomain: number[], xNeedsValueOf: boolean, yNeedsValueOf: boolean): BubbleAggregation | undefined;
