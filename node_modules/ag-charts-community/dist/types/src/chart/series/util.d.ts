...
export declare function getItemStylesPerItemId<ItemId extends string, TNodeDatum, TStyle>(getItemStyle: (nodeDatum: TNodeDatum | undefined, isHighlight: boolean, highlightState?: HighlightState, itemId?: ItemId) => TStyle, ...itemIds: ItemId[]): Record<ItemId, Record<HighlightState, TStyle>>;
