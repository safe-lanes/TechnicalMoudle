...
export declare class HierarchyNode<This extends HierarchyNode<This, TDatum> = any, TDatum = Record<string, any>> implements HierarchyNodeDatum, Pick<HighlightNodeDatum, 'colorValue'> {
    ...
    constructor(series: ISeries<any, any, any>, datumIndex: number[], datum: TDatum | undefined, sizeValue: number, colorValue: number | undefined, sumSize: number, depth: number | undefined, parent: This | undefined, children: This[], style: FillOptions & StrokeOptions);
