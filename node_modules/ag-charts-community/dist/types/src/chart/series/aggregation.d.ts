...
export declare function createAggregationIndices(xValues: any[], yMaxValues: any[], yMinValues: any[], d0: number, d1: number, maxRange: number, { positive, xNeedsValueOf, yNeedsValueOf, }?: {
    positive?: boolean;
    xNeedsValueOf?: boolean;
