import type { AgBarHighlightStyleOptions, AgGradientColor, AgGradientColorBounds, AgGradientType, AgHighlightStyleOptions, AgImageFill, AgLineHighlightStyleOptions, AgPatternColor, AgSeriesLineSegmentOptions, AgSeriesShapeSegmentOptions, BorderOptions, CssColor, FillOptions, FontOptions, LabelBoxOptions, LineDashOptions, StrokeOptions } from 'ag-charts-types';
...
export declare const shapeSegmentation: import("../utils/validation").Validator;
export declare const lineSegmentation: import("../utils/validation").Validator;
