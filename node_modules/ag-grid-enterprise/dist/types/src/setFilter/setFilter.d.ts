import type { AgPromise, ComponentSelector, ElementParams, FilterDisplayParams, IAfterGuiAttachedParams, ISetFilter, ISetFilterParams, SetFilterModel, SetFilterModelValue, SetFilterParams, SetFilterUi } from 'ag-grid-community';
import { ProvidedFilter } from 'ag-grid-community';
import type { SetFilterHandler } from './setFilterHandler';
/** @param V type of value in the Set Filter */
export declare class SetFilter<V = string> extends ProvidedFilter<SetFilterModel, V, ISetFilterParams<any, V> & FilterDisplayParams<any, any, SetFilterModel>> implements ISetFilter<V>, SetFilterUi {
