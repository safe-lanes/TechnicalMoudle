import type { BeanCollection, HighlightTooltipEventType, RichSelectParams } from 'ag-grid-community';
import { Component } from 'ag-grid-community';
export declare class RichSelectRow<TValue> extends Component<HighlightTooltipEventType> {
