import type { AgComponentSelectorType, AgEventTypeParams, AgGridCommon, AgLabelParams, BeanCollection, ComponentSelector, GridOptionsService, GridOptionsWithDefaults, LabelAlignment } from 'ag-grid-community';
...
export declare class AgSlider extends AgAbstractLabel<BeanCollection, GridOptionsWithDefaults, AgEventTypeParams, AgGridCommon<any, any>, GridOptionsService, AgComponentSelectorType, AgSliderParams, AgSliderEvent> {
