import type { ColKey, ColumnEventType, IColumnCollectionService, NamedBean, PropertyValueChangedEvent, _ColumnCollections } from 'ag-grid-community';
...
export declare class AutoColService extends BeanStub implements NamedBean, IColumnCollectionService {
    ...
    createColumns(cols: _ColumnCollections, updateOrders: (callback: (cols: AgColumn[] | null) => AgColumn[] | null) => void, source: ColumnEventType): void;
