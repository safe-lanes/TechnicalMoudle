...
var { Chart: Chart2, MercatorScale, NumberAxis, Property: Property11 } = import_ag_charts_community16._ModuleSupport;
...
var { ScalableGroup, Rect, Line: Line3, BBox: BBox2, Selection: Selection3, applyShapeFillBBox } = import_ag_charts_community19._ModuleSupport;
var BoxPlotGroup = class extends ScalableGroup {
  ...
  distanceSquared(x, y) {
    ...
    return import_ag_charts_community19._ModuleSupport.nearestSquared(x, y, nodes).distanceSquared;
  }
  get midPoint() {
    const datum = this.datum;
    if (datum.midPoint === void 0) {
      import_ag_charts_core10.Logger.error("BoxPlotGroup.datum.midPoint is undefined");
      return { x: NaN, y: NaN };
    }
...
var boxPlotSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core11.required)((0, import_ag_charts_core11.constant)("box-plot")),
  xKey: (0, import_ag_charts_core11.required)(import_ag_charts_core11.string),
  minKey: (0, import_ag_charts_core11.required)(import_ag_charts_core11.string),
  q1Key: (0, import_ag_charts_core11.required)(import_ag_charts_core11.string),
  medianKey: (0, import_ag_charts_core11.required)(import_ag_charts_core11.string),
  q3Key: (0, import_ag_charts_core11.required)(import_ag_charts_core11.string),
  maxKey: (0, import_ag_charts_core11.required)(import_ag_charts_core11.string),
  xName: import_ag_charts_core11.string,
  yName: import_ag_charts_core11.string,
  minName: import_ag_charts_core11.string,
  q1Name: import_ag_charts_core11.string,
  medianName: import_ag_charts_core11.string,
  q3Name: import_ag_charts_core11.string,
  maxName: import_ag_charts_core11.string,
  grouped: import_ag_charts_core11.boolean,
  legendItemName: import_ag_charts_core11.string
};
  ...
  series: {
    ...
    fill: {
      $if: [
        ...
        { $palette: "fill" },
        { $mix: [import_ag_charts_community23._ModuleSupport.SAFE_FILL_OPERATION, { $ref: "chartBackgroundColor" }, 0.7] }
      ]
    },
    stroke: { $palette: "stroke" },
    // @ts-expect-error undocumented option
    fillGradientDefaults: import_ag_charts_community23._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
    fillPatternDefaults: import_ag_charts_community23._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community23._ModuleSupport.FILL_IMAGE_DEFAULTS,
    strokeWidth: 2,
  ...
  createNodeData() {
    ...
    if (dataAggregationFilter == null) {
      ...
      for (let datumIndex = start; datumIndex < end; datumIndex += 1) {
        ...
        if (!validLowValue) {
          import_ag_charts_core12.Logger.warnOnce(
...
var { Path: Path5, SceneChangeDetection, BBox: BBox3 } = import_ag_charts_community27._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickNode.ts
var { SceneArrayChangeDetection, SceneChangeDetection: SceneChangeDetection2, ExtendedPath2D, BBox: BBox4 } = import_ag_charts_community28._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeriesProperties.ts
var { FillGradientDefaults: FillGradientDefaults2, FillPatternDefaults: FillPatternDefaults2, FillImageDefaults: FillImageDefaults2, BaseProperties: BaseProperties4, makeSeriesTooltip: makeSeriesTooltip3, Property: Property14 } = import_ag_charts_community30._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeries.ts
var { isGradientFill, isPatternFill, isImageFill, getShapeFill, applyShapeStyle } = import_ag_charts_community31._ModuleSupport;
...
var candlestickSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core13.required)((0, import_ag_charts_core13.constant)("candlestick")),
  xKey: (0, import_ag_charts_core13.required)(import_ag_charts_core13.string),
  openKey: (0, import_ag_charts_core13.required)(import_ag_charts_core13.string),
  highKey: (0, import_ag_charts_core13.required)(import_ag_charts_core13.string),
  lowKey: (0, import_ag_charts_core13.required)(import_ag_charts_core13.string),
  closeKey: (0, import_ag_charts_core13.required)(import_ag_charts_core13.string),
  xName: import_ag_charts_core13.string,
  yName: import_ag_charts_core13.string,
  openName: import_ag_charts_core13.string,
  highName: import_ag_charts_core13.string,
  lowName: import_ag_charts_core13.string,
  closeName: import_ag_charts_core13.string
};
candlestickSeriesOptionsDef.pickOutsideVisibleMinorAxis = (0, import_ag_charts_core13.undocumented)(import_ag_charts_core13.boolean);
candlestickSeriesOptionsDef.focusPriority = (0, import_ag_charts_core13.undocumented)(import_ag_charts_core13.number);
...
function itemTheme(key) {
  return {
    ...
    // @ts-expect-error undocumented-option
    fillGradientDefaults: import_ag_charts_community33._ModuleSupport.FILL_GRADIENT_LINEAR_SHADED_DEFAULTS(key),
    fillPatternDefaults: import_ag_charts_community33._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community33._ModuleSupport.FILL_IMAGE_DEFAULTS
  };
}
...
var { CachedTextMeasurerPool, TextUtils: TextUtils2, TextWrapper: TextWrapper2 } = import_ag_charts_community35._ModuleSupport;
...
function formatStackedLabels(labelValue, labelProps, secondaryLabelValue, secondaryLabelProps, { padding }, sizeFittingHeight) {
  ...
  let label;
  let secondaryLabel;
  return (0, import_ag_charts_core14.findMaxValue)(0, fontSizeCandidates.length - 1, (index) => {
...
function formatSingleLabel(value, props, { padding }, sizeFittingHeight) {
  ...
  return (0, import_ag_charts_core14.findMaxValue)(minimumFontSize, props.fontSize, (fontSize) => {
...
function formatLabels(baseLabelValue, labelProps, baseSecondaryLabelValue, secondaryLabelProps, layoutParams, sizeFittingHeight) {
  ...
  if (hasInvalidFontSize(labelProps) || hasInvalidFontSize(secondaryLabelProps)) {
    import_ag_charts_core14.Logger.warnOnce(`minimumFontSize should be set to a value less than or equal to the font size`);
  }
  let value;
...
var { Property: Property15 } = import_ag_charts_community36._ModuleSupport;
var BaseAutoSizedLabel = class extends import_ag_charts_community36._ModuleSupport.Label {
  constructor() {
    super(...arguments);
...
// packages/ag-charts-enterprise/src/series/heatmap/heatmapSeriesProperties.ts
var { CartesianSeriesProperties, makeSeriesTooltip: makeSeriesTooltip4, Property: Property16 } = import_ag_charts_community37._ModuleSupport;
...
var HeatmapSeriesNodeEvent = class extends import_ag_charts_community38._ModuleSupport.CartesianSeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var HeatmapSeries = class extends import_ag_charts_community38._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      propertyKeys: {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs3, heatmapSeriesThemeableOptionsDef, without } = import_ag_charts_community39._ModuleSupport;
var heatmapSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core16.required)((0, import_ag_charts_core16.constant)("heatmap")),
  xKey: (0, import_ag_charts_core16.required)(import_ag_charts_core16.string),
  yKey: (0, import_ag_charts_core16.required)(import_ag_charts_core16.string),
  colorKey: import_ag_charts_core16.string,
  xName: import_ag_charts_core16.string,
  yName: import_ag_charts_core16.string,
  colorName: import_ag_charts_core16.string,
  colorRange: (0, import_ag_charts_core16.arrayOf)(import_ag_charts_core16.color)
};
  ...
  series: {
    ...
    colorRange: {
      $if: [
        ...
        import_ag_charts_community40._ModuleSupport.SAFE_RANGE2_OPERATION
      ]
    },
    label: {
      ...import_ag_charts_community40._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      color: { $ref: "textColor" },
    ...
    itemPadding: 3,
    highlight: import_ag_charts_community40._ModuleSupport.singleSeriesHighlightStyle()
  },
  gradientLegend: {
    enabled: true,
    ...import_ag_charts_community40._ModuleSupport.LEGEND_CONTAINER_THEME
  }
};
...
var { applyShapeStyle: applyShapeStyle3 } = import_ag_charts_community42._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs4, ohlcSeriesThemeableOptionsDef } = import_ag_charts_community43._ModuleSupport;
var ohlcSeriesOptionsDef = {
  ...commonSeriesOptionsDefs4,
  ...ohlcSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core17.required)((0, import_ag_charts_core17.constant)("ohlc")),
  xKey: (0, import_ag_charts_core17.required)(import_ag_charts_core17.string),
  openKey: (0, import_ag_charts_core17.required)(import_ag_charts_core17.string),
  highKey: (0, import_ag_charts_core17.required)(import_ag_charts_core17.string),
  lowKey: (0, import_ag_charts_core17.required)(import_ag_charts_core17.string),
  closeKey: (0, import_ag_charts_core17.required)(import_ag_charts_core17.string),
  xName: import_ag_charts_core17.string,
  yName: import_ag_charts_core17.string,
  openName: import_ag_charts_core17.string,
  highName: import_ag_charts_core17.string,
  lowName: import_ag_charts_core17.string,
  closeName: import_ag_charts_core17.string
};
ohlcSeriesOptionsDef.pickOutsideVisibleMinorAxis = (0, import_ag_charts_core17.undocumented)(import_ag_charts_core17.boolean);
ohlcSeriesOptionsDef.focusPriority = (0, import_ag_charts_core17.undocumented)(import_ag_charts_core17.number);
...
var RangeAreaSeries = class extends import_ag_charts_community48._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var rangeAreaSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core18.required)((0, import_ag_charts_core18.constant)("range-area")),
...
rangeAreaSeriesOptionsDef.pickOutsideVisibleMinorAxis = (0, import_ag_charts_core18.undocumented)(import_ag_charts_core18.boolean);
rangeAreaSeriesOptionsDef.focusPriority = (0, import_ag_charts_core18.undocumented)(import_ag_charts_core18.number);
...
var RANGE_AREA_SERIES_THEME = {
  series: {
    fill: { $palette: "fill" },
    fillGradientDefaults: import_ag_charts_community50._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
    fillPatternDefaults: import_ag_charts_community50._ModuleSupport.FILL_PATTERN_DEFAULTS,
    stroke: { $palette: "stroke" },
    fillOpacity: 0.7,
    ...
    marker: {
      ...
      stroke: { $palette: "stroke" },
      // @ts-expect-error undocumented option
      fillGradientDefaults: import_ag_charts_community50._ModuleSupport.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS,
      fillPatternDefaults: import_ag_charts_community50._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community50._ModuleSupport.FILL_IMAGE_DEFAULTS,
      size: 6,
      strokeWidth: 2
    },
    label: {
...
var rangeBarSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core19.required)((0, import_ag_charts_core19.constant)("range-bar")),
...
rangeBarSeriesOptionsDef.pickOutsideVisibleMinorAxis = (0, import_ag_charts_core19.undocumented)(import_ag_charts_core19.boolean);
rangeBarSeriesOptionsDef.focusPriority = (0, import_ag_charts_core19.undocumented)(import_ag_charts_core19.number);
...
var RANGE_BAR_SERIES_THEME = {
  series: {
    ...
    stroke: { $palette: "stroke" },
    // @ts-expect-error undocumented option
    fillGradientDefaults: import_ag_charts_community56._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
    fillPatternDefaults: import_ag_charts_community56._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community56._ModuleSupport.FILL_IMAGE_DEFAULTS,
...
var waterfallSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core20.required)((0, import_ag_charts_core20.constant)("waterfall")),
  xKey: (0, import_ag_charts_core20.required)(import_ag_charts_core20.string),
  yKey: (0, import_ag_charts_core20.required)(import_ag_charts_core20.string),
  xName: import_ag_charts_core20.string,
  yName: import_ag_charts_core20.string,
  totals: (0, import_ag_charts_core20.arrayOfDefs)(
    {
      totalType: (0, import_ag_charts_core20.required)((0, import_ag_charts_core20.union)("total", "subtotal")),
      index: (0, import_ag_charts_core20.required)(import_ag_charts_core20.positiveNumber),
      axisLabel: (0, import_ag_charts_core20.required)(import_ag_charts_core20.string)
    },
...
function itemTheme2(key, index) {
  return {
    ...
    // @ts-expect-error undocumented option
    fillGradientDefaults: import_ag_charts_community61._ModuleSupport.FILL_GRADIENT_LINEAR_SHADED_DEFAULTS(key),
    fillPatternDefaults: import_ag_charts_community61._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community61._ModuleSupport.FILL_IMAGE_DEFAULTS,
...
var navigatorHandleOptionsDef = {
  width: import_ag_charts_core21.positiveNumber,
  height: import_ag_charts_core21.positiveNumber,
  grip: import_ag_charts_core21.boolean,
  fill: import_ag_charts_core21.color,
  stroke: import_ag_charts_core21.color,
  strokeWidth: import_ag_charts_core21.positiveNumber,
...
var navigatorOptionsDef = {
  ...
  height: import_ag_charts_core21.positiveNumber,
  spacing: import_ag_charts_core21.positiveNumber,
  cornerRadius: import_ag_charts_core21.number,
  mask: {
    fill: import_ag_charts_core21.color,
    fillOpacity: import_ag_charts_core21.ratio,
    stroke: import_ag_charts_core21.color,
    strokeWidth: import_ag_charts_core21.positiveNumber
  },
  ...
  miniChart: {
    enabled: import_ag_charts_core21.boolean,
    padding: {
      top: import_ag_charts_core21.positiveNumber,
      bottom: import_ag_charts_core21.positiveNumber
    },
    label: {
      enabled: import_ag_charts_core21.boolean,
      avoidCollisions: import_ag_charts_core21.boolean,
      spacing: import_ag_charts_core21.positiveNumber,
      format: numberFormatValidator,
      formatter: import_ag_charts_core21.callback,
      interval: {
        minSpacing: import_ag_charts_core21.positiveNumber,
        maxSpacing: import_ag_charts_core21.positiveNumber,
        values: import_ag_charts_core21.array,
        step: import_ag_charts_core21.number
      },
      ...import_ag_charts_core21.fontOptionsDef
    },
    series: (0, import_ag_charts_core21.arrayOfDefs)(
      (0, import_ag_charts_core21.typeUnion)(
        {
...
function removeCircularLinks(links) {
  ...
  if (circularLinks.size !== 0) {
    import_ag_charts_core22.Logger.warnOnce("Some links formed circular references. These will be removed from the output.");
  }
...
// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionSeries.ts
var { Series, DataController, keyProperty: keyProperty6, valueProperty: valueProperty7, Selection: Selection4, Group: Group5, TransformableText } = import_ag_charts_community65._ModuleSupport;
...
var { Path: Path6, SceneChangeDetection: SceneChangeDetection3 } = import_ag_charts_community66._ModuleSupport;
...
var ChordSeries = class extends FlowProportionSeries {
  ...
  createNodeData() {
    ...
    if (nodeCount * spacingSweep >= 2 * Math.PI || radius <= 0) {
      import_ag_charts_core23.Logger.warnOnce("There was insufficient space to display the Chord Series.");
      return;
    }
...
var chordSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core24.required)((0, import_ag_charts_core24.constant)("chord")),
  fromKey: (0, import_ag_charts_core24.required)(import_ag_charts_core24.string),
  toKey: (0, import_ag_charts_core24.required)(import_ag_charts_core24.string),
  sizeKey: import_ag_charts_core24.string,
  sizeName: import_ag_charts_core24.string
};
chordSeriesOptionsDef.fillGradientDefaults = (0, import_ag_charts_core24.undocumented)(import_ag_charts_core24.fillGradientDefaults);
chordSeriesOptionsDef.fillPatternDefaults = (0, import_ag_charts_core24.undocumented)(import_ag_charts_core24.fillPatternDefaults);
chordSeriesOptionsDef.fillImageDefaults = (0, import_ag_charts_core24.undocumented)(import_ag_charts_core24.fillImageDefaults);
...
var FUNNEL_SERIES_THEME = {
  series: {
    ...
    // @ts-expect-error undocumented option
    fillGradientDefaults: import_ag_charts_community71._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
    fillPatternDefaults: import_ag_charts_community71._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community71._ModuleSupport.FILL_IMAGE_DEFAULTS,
    label: {
...
var { lineDistanceSquared, BBox: BBox7, Path: Path7, SceneChangeDetection: SceneChangeDetection4 } = import_ag_charts_community72._ModuleSupport;
var delta = 1e-6;
...
// packages/ag-charts-enterprise/src/series/cone-funnel/coneFunnelSeries.ts
var { Line: Line4, ChartAxisDirection: ChartAxisDirection13 } = import_ag_charts_community76._ModuleSupport;
...
var coneFunnelSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core25.required)((0, import_ag_charts_core25.constant)("cone-funnel")),
...
var CONE_FUNNEL_SERIES_THEME = {
  series: {
    ...
    // @ts-expect-error undocumented option
    fillGradientDefaults: import_ag_charts_community78._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
    fillPatternDefaults: import_ag_charts_community78._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community78._ModuleSupport.FILL_IMAGE_DEFAULTS,
    strokeWidth: { $isUserOption: ["./strokes/0", 2, 0] },
    label: {
...
var funnelSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core26.required)((0, import_ag_charts_core26.constant)("funnel")),
...
var { BaseProperties: BaseProperties8, Property: Property23 } = import_ag_charts_community83._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/linear-gauge/linearGaugeSeriesProperties.ts
var { BaseProperties: BaseProperties9, makeSeriesTooltip: makeSeriesTooltip11, SeriesProperties: SeriesProperties2, PropertiesArray: PropertiesArray2, Property: Property24, Label: Label7, AxisLabel: AxisLabel3 } = import_ag_charts_community84._ModuleSupport;
...
var { CachedTextMeasurerPool: CachedTextMeasurerPool3, BBox: BBox8 } = import_ag_charts_community85._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path8, ExtendedPath2D: ExtendedPath2D2, BBox: BBox10, SceneChangeDetection: SceneChangeDetection5, SceneObjectChangeDetection, objectsEqual } = import_ag_charts_community90._ModuleSupport;
...
var MapLineSeries = class extends TopologySeries {
  ...
  async processData(dataController) {
    ...
    if (topology == null) {
      import_ag_charts_core29.Logger.warnOnce(`no topology was provided for [MapLineSeries]; nothing will be rendered.`);
    }
  }
  isColorScaleValid() {
    const { colorKey } = this.properties;
  ...
  createNodeData() {
    ...
    if (missingGeometries.length > 0) {
      import_ag_charts_core29.Logger.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
...
var mapLineSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core30.required)((0, import_ag_charts_core30.constant)("map-line")),
  idKey: (0, import_ag_charts_core30.required)(import_ag_charts_core30.string),
  sizeKey: import_ag_charts_core30.string,
  colorKey: import_ag_charts_core30.string,
  labelKey: import_ag_charts_core30.string,
  idName: import_ag_charts_core30.string,
  sizeName: import_ag_charts_core30.string,
  colorName: import_ag_charts_core30.string,
  labelName: import_ag_charts_core30.string,
  topology: import_ag_charts_core30.geoJson,
  topologyIdKey: import_ag_charts_core30.string,
  legendItemName: import_ag_charts_core30.string,
  title: import_ag_charts_core30.string
};
mapLineSeriesOptionsDef.colorRange = (0, import_ag_charts_core30.undocumented)((0, import_ag_charts_core30.and)((0, import_ag_charts_core30.arrayOf)(import_ag_charts_core30.color), (0, import_ag_charts_core30.arrayLength)(1)));
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId11, Group: Group8, Selection: Selection8, PointerEvents: PointerEvents6 } = import_ag_charts_community98._ModuleSupport;
var MapLineBackgroundSeries = class extends TopologySeries {
  ...
  processData() {
    ...
    if (topology == null) {
      import_ag_charts_core31.Logger.warnOnce(`no topology was provided for [MapShapeBackgroundSeries]; nothing will be rendered.`);
    }
  }
  createNodeData() {
...
var mapLineBackgroundSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core32.required)((0, import_ag_charts_core32.constant)("map-line-background")),
...
function polygonPointSearch(polygons, precision, valueFn) {
  ...
  while (queue != null) {
    ...
    queue = (0, import_ag_charts_core33.insertListItemsSorted)(queue, newLabelPlacements, labelPlacementCmp);
  }
  if (bestResult == null)
    return;
...
var MapMarkerSeries = class extends TopologySeries {
  ...
  createNodeData() {
    ...
    if (missingGeometries.length > 0) {
      import_ag_charts_core34.Logger.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
...
var mapMarkerSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core35.required)((0, import_ag_charts_core35.constant)("map-marker")),
  idKey: import_ag_charts_core35.string,
  latitudeKey: import_ag_charts_core35.string,
  longitudeKey: import_ag_charts_core35.string,
  sizeKey: import_ag_charts_core35.string,
  colorKey: import_ag_charts_core35.string,
  labelKey: import_ag_charts_core35.string,
  idName: import_ag_charts_core35.string,
  latitudeName: import_ag_charts_core35.string,
  longitudeName: import_ag_charts_core35.string,
  sizeName: import_ag_charts_core35.string,
  colorName: import_ag_charts_core35.string,
  labelName: import_ag_charts_core35.string,
  topology: import_ag_charts_core35.geoJson,
  topologyIdKey: import_ag_charts_core35.string,
  legendItemName: import_ag_charts_core35.string,
  title: import_ag_charts_core35.string
};
...
var MapMarkerModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      // @ts-expect-error undocumented option
      fillGradientDefaults: applyMapPalette(import_ag_charts_community104._ModuleSupport.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS),
      fillPatternDefaults: applyMapPalette(import_ag_charts_community104._ModuleSupport.FILL_PATTERN_DEFAULTS),
      fillImageDefaults: applyMapPalette(import_ag_charts_community104._ModuleSupport.FILL_IMAGE_DEFAULTS),
      fillOpacity: 0.5,
      label: {
...
var MapMarkerSeriesModule = {
  ...
  validate(options, optionsDefs2, path) {
    const result = (0, import_ag_charts_core36.validate)(options, optionsDefs2, path);
    ...
    if (cleared?.idKey == null && (cleared?.latitudeKey == null || cleared?.longitudeKey == null)) {
      ...
      invalid.push(new import_ag_charts_core36.ValidationError("required", message, null, path));
    }
    return result;
  }
};
...
var { Property: Property28, SeriesProperties: SeriesProperties6, makeSeriesTooltip: makeSeriesTooltip15, FillGradientDefaults: FillGradientDefaults10, FillPatternDefaults: FillPatternDefaults10, FillImageDefaults: FillImageDefaults10 } = import_ag_charts_community105._ModuleSupport;
...
var MapShapeSeries = class extends TopologySeries {
  ...
  async processData(dataController) {
    ...
    if (topology == null) {
      import_ag_charts_core37.Logger.warnOnce(`no topology was provided for [MapShapeSeries]; nothing will be rendered.`);
    }
  }
  isColorScaleValid() {
    const { colorKey } = this.properties;
  ...
  createNodeData() {
    ...
    if (missingGeometries.length > 0) {
      import_ag_charts_core37.Logger.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
...
var mapShapeSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core38.required)((0, import_ag_charts_core38.constant)("map-shape")),
  idKey: (0, import_ag_charts_core38.required)(import_ag_charts_core38.string),
  colorKey: import_ag_charts_core38.string,
  labelKey: import_ag_charts_core38.string,
  idName: import_ag_charts_core38.string,
  colorName: import_ag_charts_core38.string,
  labelName: import_ag_charts_core38.string,
  topology: import_ag_charts_core38.geoJson,
  topologyIdKey: import_ag_charts_core38.string,
  legendItemName: import_ag_charts_core38.string,
  title: import_ag_charts_core38.string
};
...
var MapShapeModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      // @ts-expect-error undocumented option
      fillGradientDefaults: applyMapPalette(import_ag_charts_community108._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS),
      fillPatternDefaults: applyMapPalette(import_ag_charts_community108._ModuleSupport.FILL_PATTERN_DEFAULTS),
      fillImageDefaults: applyMapPalette(import_ag_charts_community108._ModuleSupport.FILL_IMAGE_DEFAULTS),
      fillOpacity: 1,
      strokeWidth: 1,
      lineDash: [0],
      lineDashOffset: 0,
...
var { FillGradientDefaults: FillGradientDefaults11, FillPatternDefaults: FillPatternDefaults11, FillImageDefaults: FillImageDefaults11, Property: Property29, SeriesProperties: SeriesProperties7, makeSeriesTooltip: makeSeriesTooltip16 } = import_ag_charts_community109._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId14, Selection: Selection11, Group: Group11, PointerEvents: PointerEvents8, getShapeStyle: getShapeStyle11 } = import_ag_charts_community110._ModuleSupport;
var MapShapeBackgroundSeries = class extends TopologySeries {
  ...
  processData() {
    ...
    if (topology == null) {
      import_ag_charts_core39.Logger.warnOnce(`no topology was provided for [MapShapeBackgroundSeries]; nothing will be rendered.`);
    }
  }
  createNodeData() {
    const { id: seriesId, topology, scale } = this;
...
var mapShapeBackgroundSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core40.required)((0, import_ag_charts_core40.constant)("map-shape-background")),
...
var MapShapeBackgroundModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      strokeWidth: 1,
      // @ts-expect-error undocumented-option
      fillGradientDefaults: applyMapPalette(import_ag_charts_community112._ModuleSupport.FILL_GRADIENT_LINEAR_HIERARCHY_DEFAULTS),
      fillPatternDefaults: applyMapPalette(import_ag_charts_community112._ModuleSupport.FILL_PATTERN_HIERARCHY_DEFAULTS),
      fillImageDefaults: applyMapPalette(import_ag_charts_community112._ModuleSupport.FILL_IMAGE_DEFAULTS)
    }
  }
};
...
var RadialColumnSeriesNodeEvent = class extends import_ag_charts_community113._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends import_ag_charts_community113._ModuleSupport.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
  ...
  async processData(dataController) {
    ...
    const extraProps = [];
    if ((0, import_ag_charts_core41.isDefined)(normalizedTo)) {
  ...
  legendItemSymbol() {
    ...
    if (import_ag_charts_community113._ModuleSupport.isGradientFill(markerStyle.fill)) {
...
var { motion: motion7 } = import_ag_charts_community115._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion8 } = import_ag_charts_community116._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2, PolarZIndexMap } = import_ag_charts_community117._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs15, nightingaleSeriesThemeableOptionsDef } = import_ag_charts_community118._ModuleSupport;
var nightingaleSeriesOptionsDef = {
  ...commonSeriesOptionsDefs15,
  ...nightingaleSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core42.required)((0, import_ag_charts_core42.constant)("nightingale")),
  angleKey: (0, import_ag_charts_core42.required)(import_ag_charts_core42.string),
  ...
  grouped: import_ag_charts_core42.boolean,
  stacked: import_ag_charts_core42.boolean,
  stackGroup: import_ag_charts_core42.string,
  normalizedTo: import_ag_charts_core42.number
};
...
var NIGHTINGALE_SERIES_THEME = {
  series: {
    ...
    // @ts-expect-error undocumented option
    fillGradientDefaults: import_ag_charts_community119._ModuleSupport.FILL_GRADIENT_RADIAL_SERIES_DEFAULTS,
    fillPatternDefaults: import_ag_charts_community119._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community119._ModuleSupport.FILL_IMAGE_DEFAULTS,
    strokeWidth: 1,
    label: {
      ...import_ag_charts_community119._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: import_ag_charts_community119._ModuleSupport.multiSeriesHighlightStyle()
  },
  axes: {
...
var PyramidSeries = class extends import_ag_charts_community122._ModuleSupport.DataModelSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: void 0,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs16, pyramidSeriesThemeableOptionsDef } = import_ag_charts_community123._ModuleSupport;
var pyramidSeriesOptionsDef = {
  ...pyramidSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs16,
  type: (0, import_ag_charts_core43.required)((0, import_ag_charts_core43.constant)("pyramid")),
  stageKey: (0, import_ag_charts_core43.required)(import_ag_charts_core43.string),
  valueKey: (0, import_ag_charts_core43.required)(import_ag_charts_core43.string)
};
...
var PYRAMID_SERIES_THEME = {
  series: {
    ...
    strokes: { $palette: "strokes" },
    // @ts-expect-error undocumented option
    fillGradientDefaults: import_ag_charts_community124._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
    fillPatternDefaults: import_ag_charts_community124._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community124._ModuleSupport.FILL_IMAGE_DEFAULTS,
    label: {
    ...
    highlight: import_ag_charts_community124._ModuleSupport.singleSeriesHighlightStyle()
  }
};
...
var BASE_RADAR_SERIES_THEME = {
  series: {
    ...
    marker: {
      ...
      stroke: { $palette: "stroke" },
      // @ts-expect-error undocumented option
      fillGradientDefaults: import_ag_charts_community125._ModuleSupport.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS,
      fillPatternDefaults: import_ag_charts_community125._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community125._ModuleSupport.FILL_IMAGE_DEFAULTS,
      fillOpacity: 1,
      shape: "circle",
      size: 6,
      strokeOpacity: 1,
    ...
    highlight: import_ag_charts_community125._ModuleSupport.multiSeriesHighlightStyle(),
    tooltip: {
      range: { $path: ["/tooltip/range", "nearest"] }
    }
  },
...
var RADAR_LINE_SERIES_THEME = import_ag_charts_community125._ModuleSupport.mergeDefaults(
  {
    series: {
      stroke: import_ag_charts_community125._ModuleSupport.SAFE_STROKE_FILL_OPERATION,
      strokeWidth: 2
    }
  },
  BASE_RADAR_SERIES_THEME
);
var RADAR_AREA_SERIES_THEME = import_ag_charts_community125._ModuleSupport.mergeDefaults(
  {
    series: {
      fill: { $palette: "fill" },
      fillGradientDefaults: import_ag_charts_community125._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
      fillPatternDefaults: import_ag_charts_community125._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community125._ModuleSupport.FILL_IMAGE_DEFAULTS,
      fillOpacity: 0.8,
      strokeWidth: 2,
...
var { Label: Label12, SeriesMarker: SeriesMarker2, SeriesProperties: SeriesProperties10, makeSeriesTooltip: makeSeriesTooltip19, Property: Property32 } = import_ag_charts_community126._ModuleSupport;
...
var RadarSeriesNodeEvent = class extends import_ag_charts_community127._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends import_ag_charts_community127._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: "angleValue",
  ...
  createNodeData() {
    ...
    const nodeData = rawData.map((datum, datumIndex) => {
      ...
      if (label.enabled) {
        ...
        if (labelText) {
          let textAlign = "right";
          if ((0, import_ag_charts_core44.isNumberEqual)(cos, 0)) {
            textAlign = "center";
          } else if (cos > 0) {
            textAlign = "left";
          }
          let textBaseline = "bottom";
          if ((0, import_ag_charts_core44.isNumberEqual)(sin, 0)) {
            textBaseline = "middle";
          } else if (sin > 0) {
            textBaseline = "top";
          }
      ...
      return {
        ...
        angleValue: angleDatum,
        radiusValue: radiusDatum,
        missing: !(0, import_ag_charts_core44.isFiniteNumber)(angle) || !(0, import_ag_charts_core44.isFiniteNumber)(radius)
      };
    });
    return { itemId: radiusKey, nodeData, labelData: nodeData };
  }
...
var { FillGradientDefaults: FillGradientDefaults14, FillPatternDefaults: FillPatternDefaults14, FillImageDefaults: FillImageDefaults14, Property: Property33 } = import_ag_charts_community128._ModuleSupport;
...
var RadarAreaSeries = class extends RadarSeries {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof import_ag_charts_community129._ModuleSupport.PolarAxis ? axis : void 0;
    };
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs17, radarAreaSeriesThemeableOptionsDef } = import_ag_charts_community130._ModuleSupport;
var radarAreaSeriesOptionsDef = {
  ...commonSeriesOptionsDefs17,
  ...radarAreaSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core45.required)((0, import_ag_charts_core45.constant)("radar-area")),
  angleKey: (0, import_ag_charts_core45.required)(import_ag_charts_core45.string),
  radiusKey: (0, import_ag_charts_core45.required)(import_ag_charts_core45.string),
  angleName: import_ag_charts_core45.string,
  radiusName: import_ag_charts_core45.string
};
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs18, radarLineSeriesThemeableOptionsDef } = import_ag_charts_community132._ModuleSupport;
var radarLineSeriesOptionsDef = {
  ...commonSeriesOptionsDefs18,
  ...radarLineSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core46.required)((0, import_ag_charts_core46.constant)("radar-line")),
...
// packages/ag-charts-enterprise/src/series/radar-line/radarLineModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE5 } = import_ag_charts_community133._ModuleSupport.ThemeConstants;
var RadarLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { SectorBox: SectorBox3, motion: motion9 } = import_ag_charts_community135._ModuleSupport;
...
var RadialBarSeriesNodeEvent = class extends import_ag_charts_community136._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends import_ag_charts_community136._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  get defaultShapeStyle() {
    ...
    return {
      ...
      rotation: import_ag_charts_community136._ModuleSupport.toDegrees(angleScale.range[0]) + 90
    };
  }
  nodeFactory() {
    return new Sector5();
  ...
  async processData(dataController) {
    ...
    const stackGroupTrailingId = `${stackGroupId}-trailing`;
    const extraProps = [];
    if ((0, import_ag_charts_core47.isDefined)(normalizedTo)) {
  ...
  updateSectorSelection(selection, isHighlight) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      const fill = style.fill;
      const fillParams = import_ag_charts_community136._ModuleSupport.isGradientFill(fill) && fill.bounds !== "item" ? { centerX: 0, centerY: 0 } : void 0;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs19, radialBarSeriesThemeableOptionsDef } = import_ag_charts_community137._ModuleSupport;
var radialBarSeriesOptionsDef = {
  ...commonSeriesOptionsDefs19,
  ...radialBarSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core48.required)((0, import_ag_charts_core48.constant)("radial-bar")),
  ...
  grouped: import_ag_charts_core48.boolean,
  stacked: import_ag_charts_core48.boolean,
  stackGroup: import_ag_charts_core48.string,
  normalizedTo: import_ag_charts_core48.number
};
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    stroke: { $palette: "stroke" },
    // @ts-expect-error undocumented option
    fillGradientDefaults: import_ag_charts_community138._ModuleSupport.FILL_GRADIENT_CONIC_DEFAULTS,
    fillPatternDefaults: import_ag_charts_community138._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community138._ModuleSupport.FILL_IMAGE_DEFAULTS,
    strokeWidth: { $isUserOption: ["./stroke", 1, 0] },
    label: {
      ...import_ag_charts_community138._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
...
// packages/ag-charts-enterprise/src/series/radial-bar/radialBarModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE7 } = import_ag_charts_community139._ModuleSupport.ThemeConstants;
var RadialBarModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { Property: Property35 } = import_ag_charts_community140._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection19, PolarAxis: PolarAxis4, RadialColumnShape, getRadialColumnWidth } = import_ag_charts_community141._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs20, radialColumnSeriesThemeableOptionsDef } = import_ag_charts_community142._ModuleSupport;
var radialColumnSeriesOptionsDef = {
  ...commonSeriesOptionsDefs20,
  ...radialColumnSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core49.required)((0, import_ag_charts_core49.constant)("radial-column")),
...
var RADIAL_COLUMN_SERIES_THEME = {
  series: {
    ...
    stroke: { $palette: "stroke" },
    // @ts-expect-error undocumented option
    fillGradientDefaults: import_ag_charts_community143._ModuleSupport.FILL_GRADIENT_RADIAL_SERIES_DEFAULTS,
    fillPatternDefaults: import_ag_charts_community143._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community143._ModuleSupport.FILL_IMAGE_DEFAULTS,
    columnWidthRatio: 0.5,
    maxColumnWidthRatio: 0.5,
    strokeWidth: { $isUserOption: ["./stroke", 1, 0] },
    label: {
      ...import_ag_charts_community143._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: import_ag_charts_community143._ModuleSupport.multiSeriesHighlightStyle()
  },
  axes: {
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE9 } = import_ag_charts_community144._ModuleSupport.ThemeConstants;
...
var { SvgPath, Rotatable, Translatable, Scalable } = import_ag_charts_community145._ModuleSupport;
...
var { BaseProperties: BaseProperties10, makeSeriesTooltip: makeSeriesTooltip21, SeriesProperties: SeriesProperties12, PropertiesArray: PropertiesArray3, AxisLabel: AxisLabel4, Property: Property36, Label: Label14 } = import_ag_charts_community146._ModuleSupport;
...
var RadialGaugeBarProperties = class extends BaseProperties10 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.fills = new PropertiesArray3(import_ag_charts_community146._ModuleSupport.StopProperties);
    this.fillMode = "continuous";
    this.fillOpacity = 1;
    this.stroke = "black";
    this.strokeWidth = 0;
...
var { SectorBox: SectorBox5 } = import_ag_charts_community147._ModuleSupport;
...
var RadialGaugeSeries = class extends import_ag_charts_community148._ModuleSupport.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
    ...
    this.tickSelection = Selection15.select(this.tickGroup, import_ag_charts_community148._ModuleSupport.TransformableText);
    this.datumUnion = new DatumUnion();
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((sector, datum) => {
      ...
      sector.pointerEvents = this.properties.bar.enabled ? import_ag_charts_community148._ModuleSupport.PointerEvents.All : import_ag_charts_community148._ModuleSupport.PointerEvents.None;
      sector.fill = fill;
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, import_ag_charts_community148._ModuleSupport.Sector, (node, first, last) => {
      ...
      node.pointerEvents = import_ag_charts_community148._ModuleSupport.PointerEvents.None;
    });
  }
  updateScaleSelection(opts) {
    return opts.scaleSelection.update(opts.scaleData, void 0, (datum) => {
...
// packages/ag-charts-enterprise/src/series/radial-gauge/radialGaugeModule.ts
var { FONT_SIZE_RATIO } = import_ag_charts_community149._ModuleSupport;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $interpolate: [{ $palette: "secondDivergingColors" }, 5] },
          import_ag_charts_community149._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        defaultFill: { $path: ["/1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        stroke: { $path: ["/2", import_ag_charts_community149._ModuleSupport.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
        label: {
          fontWeight: { $ref: "fontWeight" },
      ...
      label: {
        ...import_ag_charts_community149._ModuleSupport.LABEL_BOXING_DEFAULTS,
        enabled: true,
        fontWeight: { $ref: "fontWeight" },
        fontSize: 56,
...
var RadialGaugeSeriesModule = {
  ...
  chartType: "standalone",
  enterprise: true,
  options: import_ag_charts_community149._ModuleSupport.radialGaugeSeriesOptionsDef,
...
var { BBox: BBox15, Path: Path11, SceneChangeDetection: SceneChangeDetection6, splitBezier2D } = import_ag_charts_community150._ModuleSupport;
...
var SankeySeries = class extends FlowProportionSeries {
  ...
  createNodeData() {
    ...
    if (hasNegativeNodeHeight) {
      import_ag_charts_core50.Logger.warnOnce(
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs21, sankeySeriesThemeableOptionsDef } = import_ag_charts_community153._ModuleSupport;
var sankeySeriesOptionsDef = {
  ...sankeySeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs21,
  type: (0, import_ag_charts_core51.required)((0, import_ag_charts_core51.constant)("sankey")),
  fromKey: (0, import_ag_charts_core51.required)(import_ag_charts_core51.string),
  toKey: (0, import_ag_charts_core51.required)(import_ag_charts_core51.string),
  sizeKey: import_ag_charts_core51.string,
  sizeName: import_ag_charts_core51.string
};
sankeySeriesOptionsDef.fillGradientDefaults = (0, import_ag_charts_core51.undocumented)(import_ag_charts_core51.fillGradientDefaults);
sankeySeriesOptionsDef.fillPatternDefaults = (0, import_ag_charts_core51.undocumented)(import_ag_charts_core51.fillPatternDefaults);
sankeySeriesOptionsDef.fillImageDefaults = (0, import_ag_charts_core51.undocumented)(import_ag_charts_core51.fillImageDefaults);
sankeySeriesOptionsDef.defaultColorRange = (0, import_ag_charts_core51.undocumented)((0, import_ag_charts_core51.arrayOf)((0, import_ag_charts_core51.arrayOf)(import_ag_charts_core51.color)));
sankeySeriesOptionsDef.defaultPatternFills = (0, import_ag_charts_core51.undocumented)((0, import_ag_charts_core51.arrayOf)(import_ag_charts_core51.color));
...
var SankeyModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      strokes: { $palette: "strokes" },
      // @ts-expect-error undocumented option
      fillGradientDefaults: import_ag_charts_community154._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
      fillPatternDefaults: import_ag_charts_community154._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community154._ModuleSupport.FILL_IMAGE_DEFAULTS,
      defaultColorRange: { $palette: "gradients" },
      defaultPatternFills: import_ag_charts_community154._ModuleSupport.SAFE_FILLS_OPERATION,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
      ...
      highlight: {
        ...import_ag_charts_community154._ModuleSupport.singleSeriesHighlightStyle()
      },
      label: {
        ...import_ag_charts_community154._ModuleSupport.LABEL_BOXING_DEFAULTS,
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
        fontWeight: { $ref: "fontWeight" },
        color: { $ref: "textColor" },
...
var { HierarchySeriesProperties, HighlightStyle, makeSeriesTooltip: makeSeriesTooltip23, Property: Property38 } = import_ag_charts_community155._ModuleSupport;
...
var SunburstNode = class extends import_ag_charts_community156._ModuleSupport.HierarchyNode {
  constructor() {
    super(...arguments);
    this.label = void 0;
...
var SunburstSeries = class extends import_ag_charts_community156._ModuleSupport.HierarchySeries {
  constructor(moduleCtx) {
    super(moduleCtx);
  ...
  updateNodes() {
    ...
    const updateSector = (nodeDatum, sector, highlighted) => {
      ...
      const fillBBox = import_ag_charts_community156._ModuleSupport.isGradientFill(fill) && fill.bounds !== "item" ? seriesFillBBox : void 0;
  ...
  getTooltipContent(datumIndex) {
    ...
    if (import_ag_charts_community156._ModuleSupport.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
    return this.formatTooltipWithContext(
      tooltip,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs22, sunburstSeriesThemeableOptionsDef, without: without8 } = import_ag_charts_community157._ModuleSupport;
var sunburstSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core52.required)((0, import_ag_charts_core52.constant)("sunburst")),
  labelKey: import_ag_charts_core52.string,
  secondaryLabelKey: import_ag_charts_core52.string,
  childrenKey: import_ag_charts_core52.string,
  sizeKey: import_ag_charts_core52.string,
  colorKey: import_ag_charts_core52.string,
  sizeName: import_ag_charts_core52.string,
  colorName: import_ag_charts_core52.string
};

// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { BASE_FONT_SIZE, FONT_SIZE_RATIO: FONT_SIZE_RATIO2 } = import_ag_charts_community158._ModuleSupport;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      // @ts-expect-error undocumented option
      fillGradientDefaults: import_ag_charts_community158._ModuleSupport.FILL_GRADIENT_RADIAL_REVERSED_SERIES_DEFAULTS,
      fillPatternDefaults: import_ag_charts_community158._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community158._ModuleSupport.FILL_IMAGE_DEFAULTS,
      strokeWidth: { $isUserOption: ["./strokes/0", 2, 0] },
      label: {
        ...import_ag_charts_community158._ModuleSupport.LABEL_BOXING_DEFAULTS,
        fontFamily: { $ref: "fontFamily" },
    ...
    gradientLegend: {
      enabled: true,
      ...import_ag_charts_community158._ModuleSupport.LEGEND_CONTAINER_THEME
    }
  }
};
...
var { BaseProperties: BaseProperties12, HierarchySeriesProperties: HierarchySeriesProperties2, HighlightStyle: HighlightStyle2, makeSeriesTooltip: makeSeriesTooltip24, Property: Property39, Label: Label16 } = import_ag_charts_community159._ModuleSupport;
...
var TreemapNode = class extends import_ag_charts_community160._ModuleSupport.HierarchyNode {
  constructor() {
    super(...arguments);
...
var DistantGroup = class extends import_ag_charts_community160._ModuleSupport.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends import_ag_charts_community160._ModuleSupport.HierarchySeries {
  ...
  applyGap(innerBox, childBox, allLeafNodes) {
    ...
    sides.forEach((side) => {
      if (!(0, import_ag_charts_core53.isNumberEqual)(innerBounds[side], childBounds[side])) {
  ...
  getTooltipContent(datumIndex) {
    ...
    if (import_ag_charts_community160._ModuleSupport.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs23, treemapSeriesThemeableOptionsDef, without: without9 } = import_ag_charts_community161._ModuleSupport;
var treemapSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core54.required)((0, import_ag_charts_core54.constant)("treemap")),
  labelKey: import_ag_charts_core54.string,
...
treemapSeriesOptionsDef.fillPatternDefaults = (0, import_ag_charts_core54.undocumented)(import_ag_charts_core54.fillPatternDefaults);
treemapSeriesOptionsDef.fillImageDefaults = (0, import_ag_charts_core54.undocumented)(import_ag_charts_core54.fillImageDefaults);
treemapSeriesOptionsDef.undocumentedGroupFills = (0, import_ag_charts_core54.undocumented)((0, import_ag_charts_core54.arrayOf)(import_ag_charts_core54.color));
treemapSeriesOptionsDef.undocumentedGroupStrokes = (0, import_ag_charts_core54.undocumented)((0, import_ag_charts_core54.arrayOf)(import_ag_charts_core54.color));

// packages/ag-charts-enterprise/src/series/treemap/treemapModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO3 } = import_ag_charts_community162._ModuleSupport;
var TreemapModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      colorRange: { $palette: "divergingColors" },
      // @ts-expect-error undocumented option
      fillGradientDefaults: import_ag_charts_community162._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
      ...
      group: {
        label: {
          ...import_ag_charts_community162._ModuleSupport.LABEL_BOXING_DEFAULTS,
          enabled: true,
          color: { $ref: "textColor" },
          fontStyle: void 0,
          fontWeight: { $ref: "fontWeight" },
...
// packages/ag-charts-enterprise/src/main-modules.ts
var ModuleRegistry = import_ag_charts_community163._ModuleSupport.ModuleRegistry;
