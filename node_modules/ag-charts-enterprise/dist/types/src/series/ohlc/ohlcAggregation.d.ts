...
export declare function aggregateOhlcData(scale: _ModuleSupport.ScaleType, xValues: any[], highValues: any[], lowValues: any[], domain: number[], smallestKeyInterval: number | undefined): OhlcSeriesDataAggregationFilter[] | undefined;
