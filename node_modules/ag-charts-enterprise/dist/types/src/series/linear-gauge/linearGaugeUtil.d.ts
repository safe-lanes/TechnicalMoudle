...
export declare function formatLinearGaugeLabels(series: _ModuleSupport.Series<_ModuleSupport.DatumIndexType, any, object, any>, ctx: Ctx, selection: _ModuleSupport.Selection<_ModuleSupport.Text, LinearGaugeLabelDatum>, opts: {
    padding: number;
    horizontal: boolean;
}, bboxes: {
