...
import { countFractionDigits, isNumberEqual as isNumberEqual2, wrapTextOrSegments } from "ag-charts-core";
...
import { Logger as Logger3, toPlainText } from "ag-charts-core";
...
function findSpanForX(spans, x, startIndex = 0) {
  for (let i = startIndex; i < spans.length; i++) {
    const span = spans[i];
    const [start, end] = _ModuleSupport45.spanRange(span.span);
...
var BaseSeries = _ModuleSupport48.CartesianSeries;
              ...
              $merge: [
                { $path: "/series/$index/marker/fill" },
                {
                  $applySwitch: [
                    ...
                    ["gradient", _ModuleSupport50.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS],
                    ["image", _ModuleSupport50.FILL_IMAGE_DEFAULTS],
                    ["pattern", _ModuleSupport50.FILL_PATTERN_DEFAULTS]
                  ]
                }
              ]
            },
  ...
  series: {
    fill: {
      $applySwitch: [
        { $path: "type" },
        { $palette: "fill" },
        ["gradient", _ModuleSupport50.FILL_GRADIENT_LINEAR_DEFAULTS],
        ["pattern", _ModuleSupport50.FILL_PATTERN_DEFAULTS]
      ]
    },
    fillOpacity: 0.7,
    ...
    segmentation: _ModuleSupport50.SEGMENTATION_DEFAULTS,
    invertedStyle: {
      enabled: false,
      fill: {
        $applySwitch: [
...
var RangeAreaModule = {
  ...
  predictAxis: _ModuleSupport51.predictCartesianTimeAxis,
  defaultAxes: [
...
var { AbstractBarSeriesProperties: AbstractBarSeriesProperties3, makeSeriesTooltip: makeSeriesTooltip6, Property: Property18, DropShadow: DropShadow2, Label: Label2 } = _ModuleSupport53;
  ...
  series: {
    ...
    fill: {
      $applySwitch: [
        { $path: "type" },
        { $palette: "fill" },
        ["gradient", _ModuleSupport56.FILL_GRADIENT_LINEAR_DEFAULTS],
        ["image", _ModuleSupport56.FILL_IMAGE_DEFAULTS],
        ["pattern", _ModuleSupport56.FILL_PATTERN_DEFAULTS]
      ]
    },
    stroke: { $palette: "stroke" },
    ...
    segmentation: _ModuleSupport56.SEGMENTATION_DEFAULTS
  },
  axes: {
...
var RangeBarModule = {
  ...
  predictAxis: _ModuleSupport57.predictCartesianTimeAxis,
...
var { AbstractBarSeriesProperties: AbstractBarSeriesProperties4, BaseProperties: BaseProperties6, PropertiesArray, makeSeriesTooltip: makeSeriesTooltip7, Property: Property19, DropShadow: DropShadow3, Label: Label3 } = _ModuleSupport58;
...
var { FILL_GRADIENT_LINEAR_KEYED_DEFAULTS: FILL_GRADIENT_LINEAR_KEYED_DEFAULTS2, FILL_IMAGE_DEFAULTS: FILL_IMAGE_DEFAULTS3, FILL_PATTERN_KEYED_DEFAULTS: FILL_PATTERN_KEYED_DEFAULTS2 } = _ModuleSupport61;
...
import {
  Logger as Logger5,
  cachedTextMeasurer as cachedTextMeasurer2,
  calcLineHeight,
...
// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionSeries.ts
var { Series, DataController, keyProperty: keyProperty6, valueProperty: valueProperty7, Selection: Selection3, Group: Group5, TransformableText } = _ModuleSupport65;
...
var FlowProportionSeries = class extends Series {
  ...
  async processData(dataController) {
    ...
    const nodesDataModelPromise = nodes == null ? null : nodesDataController.request(
      this.id,
      _ModuleSupport65.DataSet.wrap(nodes) ?? _ModuleSupport65.DataSet.empty(),
      {
        props: [
...
var { Path: Path7, SceneChangeDetection: SceneChangeDetection4 } = _ModuleSupport66;
  ...
  createNodeData() {
    ...
    for (const [id, { datum: node, linksBefore, linksAfter }] of nodeGraph.entries()) {
      ...
      if (size === 0) {
        ...
        node.label = toPlainText2(labelText);
      }
    }
    let labelInset = 0;
      ...
      $applyCycle: [
        ...
        [{ $path: ["/0", void 0, { $palette: "fills" }] }],
        {
          $applySwitch: [
            ...
            { $value: "$1" },
            ["gradient", _ModuleSupport71.FILL_GRADIENT_LINEAR_SINGLE_DEFAULTS],
            ["pattern", _ModuleSupport71.FILL_PATTERN_SINGLE_DEFAULTS],
            ["image", _ModuleSupport71.FILL_IMAGE_DEFAULTS]
          ]
        }
      ]
    },
...
import {
  _ModuleSupport as _ModuleSupport74
} from "ag-charts-community";
...
var { lineDistanceSquared, BBox: BBox7, Path: Path8, SceneChangeDetection: SceneChangeDetection5 } = _ModuleSupport72;
var delta = 1e-6;
...
var { Label: Label5, AbstractBarSeriesProperties: AbstractBarSeriesProperties5, makeSeriesTooltip: makeSeriesTooltip9, AxisLabel, Property: Property21 } = _ModuleSupport75;
...
// packages/ag-charts-enterprise/src/series/cone-funnel/coneFunnelSeries.ts
var { Line: Line3, ChartAxisDirection: ChartAxisDirection14 } = _ModuleSupport76;
      ...
      $applyCycle: [
        ...
        },
        {
          $applySwitch: [
            { $path: ["/type", void 0, { $value: "$1" }] },
            { $value: "$1" },
            ["gradient", _ModuleSupport78.FILL_GRADIENT_LINEAR_SINGLE_DEFAULTS],
            ["pattern", _ModuleSupport78.FILL_PATTERN_SINGLE_DEFAULTS],
            ["image", _ModuleSupport78.FILL_IMAGE_DEFAULTS]
          ]
        }
      ]
    },
...
var { Label: Label6, DropShadow: DropShadow4, AbstractBarSeriesProperties: AbstractBarSeriesProperties6, BaseProperties: BaseProperties8, makeSeriesTooltip: makeSeriesTooltip10, AxisLabel: AxisLabel2, Property: Property22 } = _ModuleSupport79;
...
import { cachedTextMeasurer as cachedTextMeasurer4, isArray as isArray3, measureTextSegments as measureTextSegments2 } from "ag-charts-core";
...
var { BaseProperties: BaseProperties9, Property: Property23 } = _ModuleSupport83;
...
import { cachedTextMeasurer as cachedTextMeasurer3, isArray as isArray2, measureTextSegments, toPlainText as toPlainText3 } from "ag-charts-core";
var { BBox: BBox8 } = _ModuleSupport85;
...
function formatLinearGaugeLabels(series, ctx, selection, opts, bboxes, datumOverrides) {
  ...
  selection.each((label, labelDatum) => {
    ...
    if (labelText == null) {
      ...
      const labelMeta = formatSingleLabel(toPlainText3(labelText), labelDatum, { padding }, sizeFittingHeight);
      layout = labelMeta?.[0];
    } else {
      const measurer = cachedTextMeasurer3(labelDatum);
      const { width, height } = isArray2(labelText) ? measureTextSegments(labelText, labelDatum) : measurer.measureLines(labelText);
      layout = {
        text: labelText,
...
var LinearGaugeSeries = class extends _ModuleSupport86.Series {
  ...
  horizontalLabelInset() {
    ...
    const labelSize = linesOrTicks.reduce((accum, text) => {
      const { width } = isArray3(text) ? measureTextSegments2(text, label) : measurer.measureLines(text);
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path9, ExtendedPath2D: ExtendedPath2D3, BBox: BBox10, SceneChangeDetection: SceneChangeDetection6, SceneObjectChangeDetection, objectsEqual } = _ModuleSupport90;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId11, Group: Group8, Selection: Selection7, PointerEvents: PointerEvents6 } = _ModuleSupport98;
...
var { Property: Property27, SeriesProperties: SeriesProperties5, makeSeriesTooltip: makeSeriesTooltip14, Label: Label9 } = _ModuleSupport101;
    ...
    series: {
      ...
      fill: applyMapPalette({
        $applySwitch: [
          { $path: "type" },
          { $mapPalette: "fill" },
          ["gradient", _ModuleSupport104.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS],
          ["image", _ModuleSupport104.FILL_IMAGE_DEFAULTS],
          ["pattern", _ModuleSupport104.FILL_PATTERN_DEFAULTS]
        ]
      }),
...
var { Property: Property28, SeriesProperties: SeriesProperties6, makeSeriesTooltip: makeSeriesTooltip15 } = _ModuleSupport105;
...
var MapShapeSeries = class extends TopologySeries {
  ...
  getLabelLayout(datum, labelValue, measurer, geometry, previousLabelLayout) {
    ...
    if (labelText == null)
      return;
    const baseSize = isArray4(labelText) ? measureTextSegments3(labelText, label) : measurer.measureLines(String(labelText));
    ...
    series: {
      fill: applyMapPalette({
        $applySwitch: [
          { $path: "type" },
          { $mapPalette: "fill" },
          ["gradient", _ModuleSupport108.FILL_GRADIENT_LINEAR_DEFAULTS],
          ["image", _ModuleSupport108.FILL_IMAGE_DEFAULTS],
          ["pattern", _ModuleSupport108.FILL_PATTERN_DEFAULTS]
        ]
      }),
...
var { Property: Property29, SeriesProperties: SeriesProperties7, makeSeriesTooltip: makeSeriesTooltip16 } = _ModuleSupport109;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId14, Selection: Selection10, Group: Group11, PointerEvents: PointerEvents8 } = _ModuleSupport110;
    ...
    series: {
      fill: applyMapPalette({
        $applySwitch: [
          ...
          ["gradient", _ModuleSupport112.FILL_GRADIENT_LINEAR_HIERARCHY_DEFAULTS],
          ["image", _ModuleSupport112.FILL_IMAGE_DEFAULTS],
          ["pattern", _ModuleSupport112.FILL_PATTERN_HIERARCHY_DEFAULTS]
        ]
      }),
      stroke: { $ref: "chartBackgroundColor" },
      strokeWidth: 1
...
var { createDatumId: createDatumId15, mergeDefaults: mergeDefaults14, toHighlightString: toHighlightString4 } = _ModuleSupport113;
function makeStylerParams(series, highlighted, highlightStateEnum) {
  ...
  const highlightState = toHighlightString4(highlightStateEnum ?? _ModuleSupport113.HighlightState.None);
  return {
    angleKey,
    cornerRadius,
    fill,
...
var RadialColumnSeriesNodeEvent = class extends _ModuleSupport114.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends _ModuleSupport114.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
  ...
  legendItemSymbol() {
    const { fill, stroke, fillOpacity, strokeOpacity, strokeWidth, lineDash, lineDashOffset } = getStyle(
      ...
      false,
      false,
      _ModuleSupport114.HighlightState.None
    );
    const markerStyle = {
    ...
    if (_ModuleSupport114.isGradientFill(markerStyle.fill)) {
...
var { SeriesProperties: SeriesProperties8, makeSeriesTooltip: makeSeriesTooltip17, Property: Property30, Label: Label10 } = _ModuleSupport115;
...
var { motion: motion7 } = _ModuleSupport116;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion8 } = _ModuleSupport117;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2, PolarZIndexMap } = _ModuleSupport118;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs15, nightingaleSeriesThemeableOptionsDef } = _ModuleSupport119;
...
var NIGHTINGALE_SERIES_THEME = {
  series: {
    ...
    strokeWidth: 1,
    label: {
      ..._ModuleSupport120.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: _ModuleSupport120.multiSeriesHighlightStyle()
  },
  axes: {
...
import {
  _ModuleSupport as _ModuleSupport123
} from "ag-charts-community";
import {
  cachedTextMeasurer as cachedTextMeasurer8,
  isArray as isArray5,
...
var { SeriesProperties: SeriesProperties9, makeSeriesTooltip: makeSeriesTooltip18, Property: Property31, Label: Label11, DropShadow: DropShadow5 } = _ModuleSupport122;
...
var PyramidSeries = class extends _ModuleSupport123.DataModelSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: void 0,
  ...
  createNodeData() {
    ...
    for (const [datumIndex, datum] of rawData.entries()) {
      ...
      const { width, height } = isArray5(text) ? measureTextSegments4(text, label) : textMeasurer.measureLines(text);
  ...
  getTooltipContent(datumIndex) {
    ...
    return this.formatTooltipWithContext(
      ...
      {
        symbol: this.legendItemSymbol(datumIndex),
        data: [{ label: toPlainText5(label), value: toPlainText5(value) }]
      },
      {
        seriesId,
        datum,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs16, pyramidSeriesThemeableOptionsDef } = _ModuleSupport124;
...
var PYRAMID_SERIES_THEME = {
  series: {
      ...
      $applyCycle: [
        ...
        { $palette: "fills" },
        {
          $applySwitch: [
            { $path: ["/type", void 0, { $value: "$1" }] },
            { $value: "$1" },
            ["gradient", _ModuleSupport125.FILL_GRADIENT_LINEAR_DEFAULTS],
            ["pattern", _ModuleSupport125.FILL_PATTERN_DEFAULTS],
            ["image", _ModuleSupport125.FILL_IMAGE_DEFAULTS]
          ]
        }
      ]
    },
    ...
    // @ts-expect-error undocumented option
    highlight: _ModuleSupport125.singleSeriesHighlightStyle()
  }
};
...
var BASE_RADAR_SERIES_THEME = {
  series: {
    stroke: { $palette: "stroke" },
    label: {
      ..._ModuleSupport126.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    marker: {
      ...
      fill: {
        $applySwitch: [
          { $path: "type" },
          { $palette: "fill" },
          ["gradient", _ModuleSupport126.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS],
          ["image", _ModuleSupport126.FILL_IMAGE_DEFAULTS],
          ["pattern", _ModuleSupport126.FILL_PATTERN_DEFAULTS]
        ]
      },
      stroke: { $palette: "stroke" },
      fillOpacity: 1,
    ...
    highlight: _ModuleSupport126.multiSeriesHighlightStyle(),
    tooltip: {
      range: { $path: ["/tooltip/range", "nearest"] }
    }
  },
...
var RADAR_LINE_SERIES_THEME = _ModuleSupport126.mergeDefaults(
  {
    series: {
      stroke: _ModuleSupport126.SAFE_STROKE_FILL_OPERATION,
      strokeWidth: 2
    }
  },
  BASE_RADAR_SERIES_THEME
);
var RADAR_AREA_SERIES_THEME = _ModuleSupport126.mergeDefaults(
  {
    series: {
      fill: {
        $applySwitch: [
          { $path: "type" },
          { $palette: "fill" },
          ["gradient", _ModuleSupport126.FILL_GRADIENT_LINEAR_DEFAULTS],
          ["image", _ModuleSupport126.FILL_IMAGE_DEFAULTS],
          ["pattern", _ModuleSupport126.FILL_PATTERN_DEFAULTS]
        ]
      },
...
import {
  _ModuleSupport as _ModuleSupport130
} from "ag-charts-community";
...
var { Label: Label12, SeriesMarker: SeriesMarker2, SeriesProperties: SeriesProperties10, makeSeriesTooltip: makeSeriesTooltip19, Property: Property32 } = _ModuleSupport127;
...
var RadarSeriesNodeEvent = class extends _ModuleSupport128.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends _ModuleSupport128.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: "angleValue",
...
import {
  _ModuleSupport as _ModuleSupport129
} from "ag-charts-community";
var { Property: Property33 } = _ModuleSupport129;
...
var RadarAreaSeries = class extends RadarSeries {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof _ModuleSupport130.PolarAxis ? axis : void 0;
    };
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs17, radarAreaSeriesThemeableOptionsDef } = _ModuleSupport131;
...
import {
  _ModuleSupport as _ModuleSupport133
} from "ag-charts-community";
var { HighlightState: HighlightState5, PointerEvents: PointerEvents11, toHighlightString: toHighlightString6 } = _ModuleSupport133;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs18, radarLineSeriesThemeableOptionsDef } = _ModuleSupport134;
...
// packages/ag-charts-enterprise/src/series/radar-line/radarLineModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE5 } = _ModuleSupport135.ThemeConstants;
var RadarLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { SeriesProperties: SeriesProperties11, makeSeriesTooltip: makeSeriesTooltip20, Property: Property34, Label: Label13 } = _ModuleSupport136;
...
var { SectorBox: SectorBox3, motion: motion9 } = _ModuleSupport137;
...
var RadialBarSeriesNodeEvent = class extends _ModuleSupport138.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends _ModuleSupport138.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  updateSectorSelection(selection, isHighlight) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      const fill = style.fill;
      const fillParams = _ModuleSupport138.isGradientFill(fill) && fill.bounds !== "item" ? { centerX: 0, centerY: 0 } : void 0;
  ...
  legendItemSymbol() {
    const { fill, stroke, fillOpacity, strokeOpacity, strokeWidth, lineDash, lineDashOffset } = getStyle(
      ...
      false,
      false,
      _ModuleSupport138.HighlightState.None
    );
    const markerStyle = {
      fill: fill ?? "rgba(0, 0, 0, 0)",
      stroke: stroke ?? "rgba(0, 0, 0, 0)",
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs19, radialBarSeriesThemeableOptionsDef } = _ModuleSupport139;
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    strokeWidth: { $isUserOption: ["./stroke", 1, 0] },
    label: {
      ..._ModuleSupport140.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: _ModuleSupport140.multiSeriesHighlightStyle()
  },
  axes: {
...
// packages/ag-charts-enterprise/src/series/radial-bar/radialBarModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE7 } = _ModuleSupport141.ThemeConstants;
var RadialBarModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { Property: Property35 } = _ModuleSupport142;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection20, PolarAxis: PolarAxis4, RadialColumnShape, getRadialColumnWidth } = _ModuleSupport143;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs20, radialColumnSeriesThemeableOptionsDef } = _ModuleSupport144;
...
var RADIAL_COLUMN_SERIES_THEME = {
  series: {
    ...
    strokeWidth: { $isUserOption: ["./stroke", 1, 0] },
    label: {
      ..._ModuleSupport145.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: _ModuleSupport145.multiSeriesHighlightStyle()
  },
  axes: {
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE9 } = _ModuleSupport146.ThemeConstants;
...
import { cachedTextMeasurer as cachedTextMeasurer9, isArray as isArray6, measureTextSegments as measureTextSegments5, toPlainText as toPlainText7 } from "ag-charts-core";
...
var { SvgPath, Rotatable, Translatable, Scalable: Scalable2 } = _ModuleSupport147;
...
var { getColorStops: getColorStops2, normalizeAngle360: normalizeAngle3606, normalizeAngle360Inclusive: normalizeAngle360Inclusive2, toDegrees } = _ModuleSupport148;
var { BaseProperties: BaseProperties11, makeSeriesTooltip: makeSeriesTooltip21, SeriesProperties: SeriesProperties12, PropertiesArray: PropertiesArray3, AxisLabel: AxisLabel4, Property: Property36, Label: Label14 } = _ModuleSupport148;
...
var RadialGaugeBarProperties = class extends BaseProperties11 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.fills = new PropertiesArray3(_ModuleSupport148.StopProperties);
    this.fillMode = "continuous";
    this.fillOpacity = 1;
    this.stroke = "black";
    this.strokeWidth = 0;
...
import { toPlainText as toPlainText6 } from "ag-charts-core";
var { SectorBox: SectorBox5 } = _ModuleSupport149;
...
function formatRadialGaugeLabels(series, ctx, selection, opts, innerRadius, datumOverrides) {
  ...
  if (secondaryLabelDatum != null && secondaryLabelText != null) {
    const layout = formatStackedLabels(
      toPlainText6(labelText),
      labelDatum,
      toPlainText6(secondaryLabelText),
      secondaryLabelDatum,
      params,
      sizeFittingHeight
    );
    ...
    const layout = formatSingleLabel(toPlainText6(labelText), labelDatum, params, sizeFittingHeight);
...
var RadialGaugeSeries = class extends _ModuleSupport150.Series {
  constructor(moduleCtx) {
    ...
    this.tickSelection = Selection14.select(this.tickGroup, _ModuleSupport150.TransformableText);
    this.datumUnion = new DatumUnion();
  ...
  layoutScale() {
    ...
    const tickData = ticks.map((value, index) => {
      ...
      if (text == null)
        return;
      const { width, height } = isArray6(text) ? measureTextSegments5(text, label) : measurer.measureLines(text);
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((sector, datum) => {
      ...
      sector.pointerEvents = this.properties.bar.enabled ? _ModuleSupport150.PointerEvents.All : _ModuleSupport150.PointerEvents.None;
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, _ModuleSupport150.Sector, (node, first, last) => {
      ...
      node.pointerEvents = _ModuleSupport150.PointerEvents.None;
    });
  }
  updateScaleSelection(opts) {
    return opts.scaleSelection.update(opts.scaleData, void 0, (datum) => {
  ...
  getCaptionText() {
    ...
    this.labelSelection.each((_label, datum) => {
      ...
      if (text != null) {
        description.push(toPlainText7(text));
      }
    });
...
// packages/ag-charts-enterprise/src/series/radial-gauge/radialGaugeModule.ts
var { FONT_SIZE_RATIO } = _ModuleSupport151;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $interpolate: [{ $palette: "secondDivergingColors" }, 5] },
          _ModuleSupport151.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        defaultFill: { $path: ["/1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        stroke: { $path: ["/2", _ModuleSupport151.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
        label: {
          fontWeight: { $ref: "fontWeight" },
...
var RadialGaugeSeriesModule = {
  ...
  chartType: "standalone",
  enterprise: true,
  options: _ModuleSupport151.radialGaugeSeriesOptionsDef,
...
import { Logger as Logger12, cachedTextMeasurer as cachedTextMeasurer10, calcLineHeight as calcLineHeight2, toPlainText as toPlainText8, wrapText as wrapText2 } from "ag-charts-core";
...
import { clamp as clamp3 } from "ag-charts-core";
var { BBox: BBox15, Path: Path12, Vec2, SceneChangeDetection: SceneChangeDetection7 } = _ModuleSupport152;
...
var SankeySeries = class extends FlowProportionSeries {
  ...
  createNodeData() {
    ...
    for (const graphNode of nodeGraph.values()) {
      ...
      node.label = toPlainText8(labelText);
      ...
      if (labelPlacement == null && edgeLabelPlacement == null) {
        ...
        const reduceLabelWidthFn = (acc, n) => {
          ...
          if (labelPlacement === "center" && edgeLabelPlacement == null)
            maxWidth /= 2;
          const text = wrapText2(node.datum.label, {
            maxWidth,
    ...
    for (const [index, column] of columns.entries()) {
      ...
      for (const n of column.nodes) {
        ...
        let text;
        if (!leading && !trailing) {
          const lineHeight = calcLineHeight2(fontSize);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs21, sankeySeriesThemeableOptionsDef } = _ModuleSupport155;
...
var SankeyModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      strokes: { $palette: "strokes" },
      // @ts-expect-error undocumented option
      fillGradientDefaults: _ModuleSupport156.FILL_GRADIENT_LINEAR_DEFAULTS,
      fillPatternDefaults: _ModuleSupport156.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport156.FILL_IMAGE_DEFAULTS,
      defaultColorRange: { $palette: "gradients" },
      defaultPatternFills: _ModuleSupport156.SAFE_FILLS_OPERATION,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
      ...
      highlight: {
        ..._ModuleSupport156.singleSeriesHighlightStyle()
      },
      label: {
        ..._ModuleSupport156.LABEL_BOXING_DEFAULTS,
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
        fontWeight: { $ref: "fontWeight" },
        color: { $ref: "textColor" },
...
var { HierarchySeriesProperties, HighlightStyle, makeSeriesTooltip: makeSeriesTooltip23, Property: Property38 } = _ModuleSupport157;
...
var SunburstNode = class extends _ModuleSupport158.HierarchyNode {
  constructor() {
    super(...arguments);
    this.label = void 0;
...
var SunburstSeries = class extends _ModuleSupport158.HierarchySeries {
  constructor(moduleCtx) {
    super(moduleCtx);
  ...
  updateNodes() {
    ...
    this.rootNode?.walk((node) => {
      ...
      const formatting = formatLabels(
        toPlainText9(labelValue),
        this.properties.label,
        toPlainText9(secondaryLabelValue),
        this.properties.secondaryLabel,
        { padding },
        sizeFittingHeight
      );
    ...
    const updateSector = (nodeDatum, sector, highlighted) => {
      ...
      const fillBBox = _ModuleSupport158.isGradientFill(fill) && fill.bounds !== "item" ? seriesFillBBox : void 0;
  ...
  getTooltipContent(datumIndex) {
    ...
    if (_ModuleSupport158.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
    return this.formatTooltipWithContext(
      tooltip,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs22, sunburstSeriesThemeableOptionsDef, without: without8 } = _ModuleSupport159;
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { BASE_FONT_SIZE, FONT_SIZE_RATIO: FONT_SIZE_RATIO2 } = _ModuleSupport160;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
        ...
        $applyCycle: [
          ...
          { $palette: "fills" },
          {
            $applySwitch: [
              { $path: ["/type", void 0, { $value: "$1" }] },
              { $value: "$1" },
              ["gradient", _ModuleSupport160.FILL_GRADIENT_RADIAL_REVERSED_SERIES_DEFAULTS],
              ["pattern", _ModuleSupport160.FILL_PATTERN_DEFAULTS],
              ["image", _ModuleSupport160.FILL_IMAGE_DEFAULTS]
            ]
          }
        ]
      },
      ...
      strokeWidth: { $isUserOption: ["./strokes/0", 2, 0] },
      label: {
        ..._ModuleSupport160.LABEL_BOXING_DEFAULTS,
        fontFamily: { $ref: "fontFamily" },
    ...
    gradientLegend: {
      enabled: true,
      ..._ModuleSupport160.LEGEND_CONTAINER_THEME
    }
  }
};
...
import {
  _ModuleSupport as _ModuleSupport162
} from "ag-charts-community";
import {
  cachedTextMeasurer as cachedTextMeasurer11,
  calcLineHeight as calcLineHeight3,
...
var { BaseProperties: BaseProperties13, HierarchySeriesProperties: HierarchySeriesProperties2, HighlightStyle: HighlightStyle2, makeSeriesTooltip: makeSeriesTooltip24, Property: Property39, Label: Label16 } = _ModuleSupport161;
...
var TreemapNode = class extends _ModuleSupport162.HierarchyNode {
  constructor() {
    super(...arguments);
...
var DistantGroup = class extends _ModuleSupport162.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends _ModuleSupport162.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  updateNodes() {
    ...
    this.rootNode?.walk((node) => {
      ...
      node.labelValue = toPlainText10(labelValue);
      node.secondaryLabelValue = toPlainText10(secondaryLabelValue);
    });
    const { width, height } = seriesRect;
    ...
    this.rootNode?.walk((node) => {
      ...
      if (children.length === 0) {
        ...
        const text = wrapText3(labelValue, {
        ...
        node.label = {
          ...
          lineHeight: calcLineHeight3(group.label.fontSize),
          fontStyle,
          fontFamily,
          fontWeight,
          color: color6,
  ...
  getTooltipContent(datumIndex) {
    ...
    if (_ModuleSupport162.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs23, treemapSeriesThemeableOptionsDef, without: without9 } = _ModuleSupport163;
...
// packages/ag-charts-enterprise/src/series/treemap/treemapModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO3 } = _ModuleSupport164;
var TreemapModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
        ...
        $applyCycle: [
          ...
          { $palette: "fills" },
          {
            $applySwitch: [
              { $path: ["/type", void 0, { $value: "$1" }] },
              { $value: "$1" },
              ["gradient", _ModuleSupport164.FILL_GRADIENT_LINEAR_DEFAULTS],
              ["pattern", _ModuleSupport164.FILL_PATTERN_DEFAULTS],
              ["image", _ModuleSupport164.FILL_IMAGE_DEFAULTS]
            ]
          }
        ]
      },
      ...
      group: {
        label: {
          ..._ModuleSupport164.LABEL_BOXING_DEFAULTS,
          enabled: true,
          color: { $ref: "textColor" },
          fontStyle: void 0,
          fontWeight: { $ref: "fontWeight" },
    ...
    gradientLegend: {
      enabled: true,
      ..._ModuleSupport164.LEGEND_CONTAINER_THEME
    }
  }
};
...
// packages/ag-charts-enterprise/src/main-modules.ts
var ModuleRegistry = _ModuleSupport165.ModuleRegistry;
