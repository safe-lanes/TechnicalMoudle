    ...
    const labelData = ticks.map((datum, index) => {
      ...
      if (box && options.hideWhenNecessary && !rotation) {
        ...
        if (overflowLeft > pixelError || overflowRight > pixelError) {
          ...
          text = (0, import_ag_charts_core3.wrapTextOrSegments)(text, wrapOptions);
          tempText.text = text;
...
function clippedRoundRect(path, horizontal, x, y, width, height, cornerRadii, clipBBox) {
  if (horizontal) {
    baseClippedRoundRect(
      ...
      width,
      cornerRadii,
      clipBBox == null ? void 0 : new BBox2(clipBBox.y, clipBBox.x, clipBBox.height, clipBBox.width)
    );
  } else {
...
var BoxPlotSeries = class extends import_ag_charts_community21._ModuleSupport.AbstractBarSeries {
  ...
  makeStylerParams(highlighted, highlightStateEnum) {
  ...
  getStyle(ignoreStylerCallback, highlighted, highlightState) {
    const {
      cap,
      cornerRadius,
      fill,
  ...
  getItemStyle(datumIndex, isHighlight, highlightState) {
    ...
    let style = mergeDefaults2(highlightStyle, this.getStyle(datumIndex === void 0, isHighlight, highlightState));
...
var OhlcSeriesBase = class extends import_ag_charts_community26._ModuleSupport.AbstractBarSeries {
  ...
  makeItemStylerParams(itemId, datumIndex, isHighlight, style) {
...
var HeatmapSeries = class extends import_ag_charts_community37._ModuleSupport.CartesianSeries {
  ...
  createNodeData() {
    ...
    for (const [datumIndex, datum] of rawData.entries()) {
      ...
      const labels = formatLabels(
        (0, import_ag_charts_core14.toPlainText)(labelText),
  ...
  getItemStyle({ datumIndex, datum, colorValue }, isHighlight) {
    ...
    const style = mergeDefaults4(highlightStyle, {
    ...
    return overrides ? mergeDefaults4(overrides, style) : style;
  }
...
function aggregationContainsTopIndex(xValues, d0, d1, indexData, maxRange, datumIndex, xNeedsValueOf) {
  const xValue2 = xValues[datumIndex];
  if (xValue2 == null)
    return false;
  const xRatio = aggregationXRatioForXValue(xValue2, d0, d1, xNeedsValueOf);
  const aggIndex = aggregationIndexForXRatio(xRatio, maxRange);
  return datumIndex === indexData[aggIndex + AGGREGATION_INDEX_Y_MAX2];
}
function aggregationContainsBottomIndex(xValues, d0, d1, indexData, maxRange, datumIndex, xNeedsValueOf) {
  const xValue2 = xValues[datumIndex];
  if (xValue2 == null)
    return false;
  const xRatio = aggregationXRatioForXValue(xValue2, d0, d1, xNeedsValueOf);
...
function aggregateRangeAreaData(scale, xValues, highValues, lowValues, domain, xNeedsValueOf, yNeedsValueOf) {
  if (xValues.length < AGGREGATION_THRESHOLD2)
    return;
  const [d0, d1] = aggregationDomain2(scale, domain);
  let maxRange = aggregationRangeFittingPoints2(xValues, d0, d1, { xNeedsValueOf });
  ...
  while (maxRange > 64) {
    ...
    topIndices = topIndices.filter(
      (datumIndex) => aggregationContainsTopIndex(xValues, d0, d1, indexData, maxRange, datumIndex, xNeedsValueOf)
    );
    bottomIndices = bottomIndices.filter(
      (datumIndex) => aggregationContainsBottomIndex(xValues, d0, d1, indexData, maxRange, datumIndex, xNeedsValueOf)
    );
...
function findSpanForX(spans, x, startIndex = 0) {
  for (let i = startIndex; i < spans.length; i++) {
    const span = spans[i];
    const [start, end] = import_ag_charts_community45._ModuleSupport.spanRange(span.span);
...
var RangeAreaLineStyle = class extends BaseProperties5 {
  constructor() {
    super(...arguments);
    this.stroke = "#99CCFF";
    this.strokeWidth = 1;
...
var RangeAreaItemProperties = class extends BaseProperties5 {
  constructor() {
    super(...arguments);
...
var SharedRangeAreaMarker = class extends BaseProperties5 {
};
__decorateClass([
  Property17
...
var RangeAreaSeriesNodeEvent = class extends import_ag_charts_community48._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var BaseSeries = import_ag_charts_community48._ModuleSupport.CartesianSeries;
var RangeAreaSeries = class extends BaseSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      pathsPerSeries: ["fill", "lowStroke", "highStroke"],
      pickModes: [import_ag_charts_community48._ModuleSupport.SeriesNodePickMode.AXIS_ALIGNED],
      propertyKeys: {
  ...
  createNodeData() {
    ...
    const handleDatumPoint = (datumIndex, yHighValue, yLowValue) => {
      ...
      if (xValue2 == null)
        return;
      const currentSpanPoints = spanPoints.at(-1);
  ...
  updatePathNodes(opts) {
    ...
    const { item, fill, fillOpacity, opacity } = mergeDefaults5(
      highlightStyle,
    ...
    const fillBBox = this.getShapeFillBBox();
    applyShapeFillBBox2(fillPath, fill, fillBBox);
    applyShapeStyle4(fillPath, { stroke: void 0, fill, fillOpacity, opacity }, fillBBox);
  ...
  updateDatumSelection(opts) {
    ...
    const markersEnabled = markerEnabled(processedData.input.count, axes[ChartAxisDirection10.X].scale, {
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((node, datum) => {
      const { itemId } = datum;
      const style = datum.style ?? contextNodeData.styles[itemId][this.getHighlightState(highlightedDatum, isHighlight, datum.datumIndex)];
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs5, rangeAreaSeriesThemeableOptionsDef } = import_ag_charts_community49._ModuleSupport;
var rangeAreaSeriesOptionsDef = {
  ...
  legendItemName: import_ag_charts_core17.string,
  segmentation: import_ag_charts_core17.shapeSegmentation,
  invertedStyle: {
    enabled: import_ag_charts_core17.boolean,
    ...import_ag_charts_core17.fillOptionsDef
  }
};
              ...
              $merge: [
                { $path: "/series/$index/marker/fill" },
                {
                  $applySwitch: [
                    ...
                    ["gradient", import_ag_charts_community50._ModuleSupport.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS],
                    ["image", import_ag_charts_community50._ModuleSupport.FILL_IMAGE_DEFAULTS],
                    ["pattern", import_ag_charts_community50._ModuleSupport.FILL_PATTERN_DEFAULTS]
                  ]
                }
              ]
            },
...
var RANGE_AREA_SERIES_THEME = {
  series: {
    fill: {
      $applySwitch: [
        { $path: "type" },
        { $palette: "fill" },
        ["gradient", import_ag_charts_community50._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS],
        ["pattern", import_ag_charts_community50._ModuleSupport.FILL_PATTERN_DEFAULTS]
      ]
    },
    fillOpacity: 0.7,
    ...
    label: {
      ...import_ag_charts_community50._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      placement: "outside",
    ...
    highlight: import_ag_charts_community50._ModuleSupport.multiSeriesHighlightStyle(),
    segmentation: import_ag_charts_community50._ModuleSupport.SEGMENTATION_DEFAULTS,
    invertedStyle: {
      enabled: false,
      fill: {
        $applySwitch: [
  ...
  axes: {
    [import_ag_charts_community50._ModuleSupport.ThemeConstants.CARTESIAN_AXIS_TYPE.NUMBER]: {
...
var RangeAreaModule = {
  ...
  predictAxis: import_ag_charts_community51._ModuleSupport.predictCartesianTimeAxis,
  defaultAxes: [
...
var { aggregationDomain: aggregationDomain3, aggregationRangeFittingPoints: aggregationRangeFittingPoints3, compactAggregationIndices: compactAggregationIndices3, createAggregationIndices: createAggregationIndices3 } = import_ag_charts_community52._ModuleSupport;
...
var { AbstractBarSeriesProperties: AbstractBarSeriesProperties3, makeSeriesTooltip: makeSeriesTooltip6, Property: Property18, DropShadow: DropShadow2, Label: Label2 } = import_ag_charts_community53._ModuleSupport;
...
var RangeBarSeriesNodeEvent = class extends import_ag_charts_community54._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var RangeBarSeries = class extends import_ag_charts_community54._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getItemStyle(datumIndex, isHighlight, highlightState) {
    ...
    const { itemStyler } = properties;
    const highlightStyle = this.getHighlightStyle(isHighlight, datumIndex, highlightState);
    let style = mergeDefaults6(highlightStyle, this.getStyle(datumIndex === void 0, isHighlight, highlightState));
    if (itemStyler && dataModel != null && processedData != null && datumIndex != null) {
      const xValue2 = dataModel.resolveKeysById(this, `xValue`, processedData)[datumIndex];
      const overrides = this.cachedDatumCallback(
  ...
  animateWaitingUpdateReady(data) {
    ...
    const dataDiff = import_ag_charts_community54._ModuleSupport.calculateDataDiff(
      this.id,
      datumSelections,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs6, rangeBarSeriesThemeableOptionsDef } = import_ag_charts_community55._ModuleSupport;
var rangeBarSeriesOptionsDef = {
  ...
  legendItemName: import_ag_charts_core18.string,
  ...
  series: {
    ...
    fill: {
      $applySwitch: [
        { $path: "type" },
        { $palette: "fill" },
        ["gradient", import_ag_charts_community56._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS],
        ["image", import_ag_charts_community56._ModuleSupport.FILL_IMAGE_DEFAULTS],
        ["pattern", import_ag_charts_community56._ModuleSupport.FILL_PATTERN_DEFAULTS]
      ]
    },
    stroke: { $palette: "stroke" },
    strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
    label: {
      ...import_ag_charts_community56._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: import_ag_charts_community56._ModuleSupport.multiSeriesHighlightStyle(),
    segmentation: import_ag_charts_community56._ModuleSupport.SEGMENTATION_DEFAULTS
  },
  axes: {
...
var RangeBarModule = {
  ...
  predictAxis: import_ag_charts_community57._ModuleSupport.predictCartesianTimeAxis,
  defaultAxes: import_ag_charts_community57._ModuleSupport.DIRECTION_SWAP_AXES,
...
var { AbstractBarSeriesProperties: AbstractBarSeriesProperties4, BaseProperties: BaseProperties6, PropertiesArray, makeSeriesTooltip: makeSeriesTooltip7, Property: Property19, DropShadow: DropShadow3, Label: Label3 } = import_ag_charts_community58._ModuleSupport;
var WaterfallSeriesTotal = class extends BaseProperties6 {
};
__decorateClass([
  Property19
...
var WaterfallSeriesItemTooltip = class extends BaseProperties6 {
};
__decorateClass([
  Property19
...
var WaterfallSeriesItem = class extends BaseProperties6 {
  constructor() {
    super(...arguments);
    this.fill = "#c16068";
    this.stroke = "#c16068";
...
var WaterfallSeriesConnectorLine = class extends BaseProperties6 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.stroke = "black";
...
var WaterfallSeriesItems = class extends BaseProperties6 {
  constructor() {
    super(...arguments);
...
var WaterfallSeries = class extends import_ag_charts_community59._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
    ...
    const { processedData } = await this.requestDataModel(
      ...
      DataSet.wrap(dataWithTotals),
      {
        props: [
          ...
          ...isContinuousX ? [import_ag_charts_community59._ModuleSupport.SMALLEST_KEY_INTERVAL, import_ag_charts_community59._ModuleSupport.LARGEST_KEY_INTERVAL] : [],
          ...extraProps
        ]
      }
    );
  ...
  makeItemStylerParams(itemId, datumIndex, datum, isHighlight, style) {
    const { id: seriesId, properties } = this;
    const { xKey, yKey } = properties;
    const activeHighlight = this.ctx.highlightManager?.getActiveHighlight();
    const highlightStateString = this.getHighlightStateString(activeHighlight, isHighlight, datumIndex);
  ...
  animateConnectorLinesHorizontal(opts) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: import_ag_charts_community59._ModuleSupport.Motion.easeOut,
      collapsable: false,
      onUpdate(pointX) {
        linePath.clear(true);
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: import_ag_charts_community59._ModuleSupport.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs7, waterfallSeriesThemeableOptionsDef } = import_ag_charts_community60._ModuleSupport;
...
var { FILL_GRADIENT_LINEAR_KEYED_DEFAULTS: FILL_GRADIENT_LINEAR_KEYED_DEFAULTS2, FILL_IMAGE_DEFAULTS: FILL_IMAGE_DEFAULTS3, FILL_PATTERN_KEYED_DEFAULTS: FILL_PATTERN_KEYED_DEFAULTS2 } = import_ag_charts_community61._ModuleSupport;
function itemTheme2(key, index) {
  return {
    ...
    strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
    label: {
      ...import_ag_charts_community61._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontStyle: void 0,
      fontWeight: { $ref: "fontWeight" },
      fontSize: { $ref: "fontSize" },
...
var WATERFALL_SERIES_THEME = {
  series: {
    ...
    highlight: import_ag_charts_community61._ModuleSupport.singleSeriesHighlightStyle()
  },
  legend: {
    enabled: true,
    toggleSeries: false
...
var navigatorOptionsDef = {
  ...
  miniChart: {
    ...
    label: {
      ...
      formatter: (0, import_ag_charts_core20.callbackOf)(textOrSegments),
      interval: {
...
// packages/ag-charts-enterprise/src/features/sync/pluginModules.ts
var { annotationOptionsDef } = import_ag_charts_community64._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionSeries.ts
var { Series, DataController, keyProperty: keyProperty6, valueProperty: valueProperty7, Selection: Selection3, Group: Group5, TransformableText } = import_ag_charts_community65._ModuleSupport;
var FlowProportionSeriesNodeEvent = class extends import_ag_charts_community65._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var FlowProportionSeries = class extends Series {
  ...
  async processData(dataController) {
    ...
    const nodesDataModelPromise = nodes == null ? null : nodesDataController.request(
      this.id,
      import_ag_charts_community65._ModuleSupport.DataSet.wrap(nodes) ?? import_ag_charts_community65._ModuleSupport.DataSet.empty(),
      {
        props: [
  ...
  update(opts) {
    ...
    this.contentGroup.opacity = highlightedDatum == null ? 1 : this.properties.highlight.unhighlightedItem.opacity ?? 1;
...
var { Path: Path7, SceneChangeDetection: SceneChangeDetection4 } = import_ag_charts_community66._ModuleSupport;
...
var ChordSeriesLinkProperties = class extends BaseProperties7 {
  constructor() {
    super(...arguments);
    this.fill = void 0;
    this.fillOpacity = 1;
...
var ChordSeriesNodeProperties = class extends BaseProperties7 {
  constructor() {
    super(...arguments);
    this.spacing = 1;
    this.width = 1;
...
var ChordSeries = class extends FlowProportionSeries {
  ...
  createNodeData() {
    ...
    for (const [id, { datum: node, linksBefore, linksAfter }] of nodeGraph.entries()) {
      ...
      if (size === 0) {
        ...
        node.label = (0, import_ag_charts_core22.toPlainText)(labelText);
      }
    }
    let labelInset = 0;
  ...
  getNodeStyle(nodeDatum, fromNodeDatumIndex, isHighlight) {
    ...
    if (itemStyler != null && nodeDatum.datumIndex != null) {
      const overrides = this.cachedDatumCallback(
        createDatumId6(nodeDatum.datumIndex.index, "node", isHighlight ? "highlight" : "node"),
        () => {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs8, chordSeriesThemeableOptionsDef } = import_ag_charts_community69._ModuleSupport;
...
var ChordModule = {
  ...
  themeTemplate: {
    series: {
      ...
      // @ts-expect-error undocumented option
      fillGradientDefaults: import_ag_charts_community70._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
      fillPatternDefaults: import_ag_charts_community70._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community70._ModuleSupport.FILL_IMAGE_DEFAULTS,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
...
var FUNNEL_SERIES_THEME = {
  series: {
      ...
      $applyCycle: [
        ...
        [{ $path: ["/0", void 0, { $palette: "fills" }] }],
        {
          $applySwitch: [
            ...
            { $value: "$1" },
            ["gradient", import_ag_charts_community71._ModuleSupport.FILL_GRADIENT_LINEAR_SINGLE_DEFAULTS],
            ["pattern", import_ag_charts_community71._ModuleSupport.FILL_PATTERN_SINGLE_DEFAULTS],
            ["image", import_ag_charts_community71._ModuleSupport.FILL_IMAGE_DEFAULTS]
          ]
        }
      ]
    },
    ...
    label: {
      ...import_ag_charts_community71._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: import_ag_charts_community71._ModuleSupport.singleSeriesHighlightStyle()
  },
  axes: {
...
var { lineDistanceSquared, BBox: BBox7, Path: Path8, SceneChangeDetection: SceneChangeDetection5 } = import_ag_charts_community72._ModuleSupport;
var delta = 1e-6;
...
var { NODE_UPDATE_STATE_TO_PHASE_MAPPING } = import_ag_charts_community73._ModuleSupport;
...
var FunnelSeriesNodeEvent = class extends import_ag_charts_community74._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var BaseFunnelSeries = class extends import_ag_charts_community74._ModuleSupport.AbstractBarSeries {
  constructor({
    moduleCtx,
    animationResetFns
  }) {
...
var { Label: Label5, AbstractBarSeriesProperties: AbstractBarSeriesProperties5, makeSeriesTooltip: makeSeriesTooltip9, AxisLabel, Property: Property21 } = import_ag_charts_community75._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/cone-funnel/coneFunnelSeries.ts
var { Line: Line3, ChartAxisDirection: ChartAxisDirection14 } = import_ag_charts_community76._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs9, coneFunnelSeriesThemeableOptionsDef, without: without3 } = import_ag_charts_community77._ModuleSupport;
...
var CONE_FUNNEL_SERIES_THEME = {
  series: {
      ...
      $applyCycle: [
        { $size: { $path: ["./data", { $path: "/data" }] } },
        {
          $if: [
            ...
            import_ag_charts_community78._ModuleSupport.SAFE_RANGE2_OPERATION
          ]
        },
        {
          $applySwitch: [
            { $path: ["/type", void 0, { $value: "$1" }] },
            { $value: "$1" },
            ["gradient", import_ag_charts_community78._ModuleSupport.FILL_GRADIENT_LINEAR_SINGLE_DEFAULTS],
            ["pattern", import_ag_charts_community78._ModuleSupport.FILL_PATTERN_SINGLE_DEFAULTS],
            ["image", import_ag_charts_community78._ModuleSupport.FILL_IMAGE_DEFAULTS]
          ]
        }
      ]
    },
    ...
    strokeWidth: { $isUserOption: ["./strokes/0", 2, 0] },
    label: {
      ...import_ag_charts_community78._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: import_ag_charts_community78._ModuleSupport.singleSeriesHighlightStyle(false)
  },
  seriesArea: {
    padding: {
      top: 20,
...
var { Label: Label6, DropShadow: DropShadow4, AbstractBarSeriesProperties: AbstractBarSeriesProperties6, BaseProperties: BaseProperties8, makeSeriesTooltip: makeSeriesTooltip10, AxisLabel: AxisLabel2, Property: Property22 } = import_ag_charts_community79._ModuleSupport;
...
var FunnelDropOff = class extends BaseProperties8 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.fill = void 0;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs10, funnelSeriesThemeableOptionsDef, without: without4 } = import_ag_charts_community81._ModuleSupport;
...
function formatWithContext(ctx, formatter, params) {
  return import_ag_charts_community82._ModuleSupport.callWithContext(ctx.chartService, formatter, params);
}
...
function getLabelText(seriesId, ctx, datum, valueOverride) {
  ...
  return labelFormat == null || (0, import_ag_charts_core26.isArray)(labelFormat) ? labelFormat : String(labelFormat);
}
...
function pickGaugeNearestDatum(self, point) {
  const it = (0, import_ag_charts_core27.iterate)(self.datumUnion.nodes(), self.targetSelection.nodes());
...
function pickGaugeFocus(self, opts) {
  ...
  const otherIndex = (0, import_ag_charts_core27.clamp)(0, opts.otherIndex + opts.otherIndexDelta, others.length - 1);
  if (others.length === 0)
    return;
  const { data, selection } = others[otherIndex];
  if (data == null || data.length === 0)
    return;
  const datumIndex = (0, import_ag_charts_core27.clamp)(0, opts.datumIndex, data.length - 1);
...
var { BaseProperties: BaseProperties9, Property: Property23 } = import_ag_charts_community83._ModuleSupport;
var GaugeSegmentationIntervalProperties = class extends BaseProperties9 {
...
var GaugeSegmentationProperties = class extends BaseProperties9 {
  constructor() {
    super(...arguments);
    this.enabled = false;
...
var LinearGaugeTargetProperties = class extends BaseProperties10 {
  constructor() {
    super(...arguments);
    this.value = 0;
...
var LinearGaugeBarProperties = class extends BaseProperties10 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.thicknessRatio = 1;
    this.fills = new PropertiesArray2(import_ag_charts_community84._ModuleSupport.StopProperties);
...
var LinearGaugeScaleIntervalProperties = class extends BaseProperties10 {
  constructor() {
    super(...arguments);
    this.values = void 0;
    this.step = void 0;
...
var LinearGaugeScaleProperties = class extends BaseProperties10 {
  constructor() {
    super(...arguments);
    this.min = 0;
    this.max = 1;
...
var { BBox: BBox8 } = import_ag_charts_community85._ModuleSupport;
...
function formatLinearGaugeLabels(series, ctx, selection, opts, bboxes, datumOverrides) {
  ...
  selection.each((label, labelDatum) => {
    ...
    if (labelText == null) {
      ...
      const labelMeta = formatSingleLabel((0, import_ag_charts_core29.toPlainText)(labelText), labelDatum, { padding }, sizeFittingHeight);
      layout = labelMeta?.[0];
    } else {
      const measurer = (0, import_ag_charts_core29.cachedTextMeasurer)(labelDatum);
      const { width, height } = (0, import_ag_charts_core29.isArray)(labelText) ? (0, import_ag_charts_core29.measureTextSegments)(labelText, labelDatum) : measurer.measureLines(labelText);
      layout = {
        text: labelText,
...
var LinearGaugeSeries = class extends import_ag_charts_community86._ModuleSupport.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  horizontalLabelInset() {
    ...
    const labelSize = linesOrTicks.reduce((accum, text) => {
      const { width } = (0, import_ag_charts_core30.isArray)(text) ? (0, import_ag_charts_core30.measureTextSegments)(text, label) : measurer.measureLines(text);
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      rect.pointerEvents = this.properties.bar.enabled ? import_ag_charts_community86._ModuleSupport.PointerEvents.All : import_ag_charts_community86._ModuleSupport.PointerEvents.None;
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, import_ag_charts_community86._ModuleSupport.Rect, (node, first, last) => {
      ...
      node.pointerEvents = import_ag_charts_community86._ModuleSupport.PointerEvents.None;
      node.x = left;
      node.y = top;
      node.width = width;
      node.height = height;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          ...
          import_ag_charts_community87._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        ...
        stroke: { $path: ["/2", import_ag_charts_community87._ModuleSupport.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
        label: {
          spacing: 11
      ...
      label: {
        ...import_ag_charts_community87._ModuleSupport.LABEL_BOXING_DEFAULTS,
        enabled: false,
        placement: "inside-start",
        fontFamily: { $ref: "fontFamily" },
        fontWeight: { $ref: "fontWeight" },
        fontSize: { $rem: 2 },
        minimumFontSize: import_ag_charts_community87._ModuleSupport.FONT_SIZE.SMALL,
        spacing: 18,
        color: { $ref: "chartBackgroundColor" }
      },
      margin: 4,
...
var LinearGaugeSeriesModule = {
  ...
  chartType: "standalone",
  enterprise: true,
  options: import_ag_charts_community87._ModuleSupport.linearGaugeSeriesOptionsDef,
...
var MAP_THEME_DEFAULTS = {
  ...
  gradientLegend: {
    enabled: false,
    ...import_ag_charts_community88._ModuleSupport.LEGEND_CONTAINER_THEME
  }
};
function applyMapPalette(object) {
  const clone = import_ag_charts_community88._ModuleSupport.deepClone(object);
  import_ag_charts_community88._ModuleSupport.jsonWalk(clone, (value) => {
...
var { LonLatBBox } = import_ag_charts_community89._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path9, ExtendedPath2D: ExtendedPath2D3, BBox: BBox10, SceneChangeDetection: SceneChangeDetection6, SceneObjectChangeDetection, objectsEqual } = import_ag_charts_community90._ModuleSupport;
...
var { LonLatBBox: LonLatBBox2 } = import_ag_charts_community91._ModuleSupport;
...
var TopologySeriesProperties = class extends import_ag_charts_community92._ModuleSupport.SeriesProperties {
};
var TopologySeries = class extends import_ag_charts_community92._ModuleSupport.DataModelSeries {
...
var { Property: Property25, SeriesProperties: SeriesProperties3, makeSeriesTooltip: makeSeriesTooltip12, Label: Label8 } = import_ag_charts_community93._ModuleSupport;
...
var MapLineSeries = class extends TopologySeries {
  ...
  createNodeData() {
    ...
    const labelValues = labelKey == null ? void 0 : dataModel.resolveColumnById(this, `labelValue`, processedData);
    const sizeValues = sizeKey == null ? void 0 : dataModel.resolveColumnById(this, `sizeValue`, processedData);
    const colorValues = colorKey == null ? void 0 : dataModel.resolveColumnById(this, `colorValue`, processedData);
    ...
    const measurer = (0, import_ag_charts_core31.cachedTextMeasurer)(label);
  ...
  getItemStyle({ datumIndex = 0, datum, colorValue, sizeValue }, isHighlight) {
    ...
    const highlightStyle = this.getHighlightStyle(isHighlight, datumIndex);
    const style = mergeDefaults11(highlightStyle, properties.getStyle());
    if (!isHighlight && colorValue != null) {
      style.stroke = this.isColorScaleValid() ? colorScale.convert(colorValue) : colorRange?.[0] ?? properties.stroke;
    }
    if (sizeValue != null) {
    ...
    return overrides ? mergeDefaults11(style, overrides) : style;
  }
  makeItemStylerParams(datum, datumIndex, isHighlight, style) {
    const { id: seriesId } = this;
    const activeHighlight = this.ctx.highlightManager?.getActiveHighlight();
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = import_ag_charts_community94._ModuleSupport.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs11, mapLineSeriesThemeableOptionsDef, without: without5 } = import_ag_charts_community95._ModuleSupport;
...
var MapLineModule = {
  ...
  themeTemplate: {
    ...MAP_THEME_DEFAULTS,
    series: {
      stroke: applyMapPalette(import_ag_charts_community96._ModuleSupport.SAFE_STROKE_FILL_OPERATION),
      // @ts-expect-error undocumented option
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(import_ag_charts_community96._ModuleSupport.SAFE_RANGE2_OPERATION)
        ]
      },
      strokeWidth: 1,
      maxStrokeWidth: 3,
      ...
      lineDashOffset: 0,
      label: {
        ...import_ag_charts_community96._ModuleSupport.LABEL_BOXING_DEFAULTS,
        enabled: true,
        fontSize: { $ref: "fontSize" },
        fontFamily: { $ref: "fontFamily" },
        fontWeight: { $ref: "fontWeight" },
      ...
      highlight: applyMapPalette(import_ag_charts_community96._ModuleSupport.multiSeriesHighlightStyle(false))
    },
    tooltip: {
      range: "exact"
    }
...
var { Property: Property26, SeriesProperties: SeriesProperties4, makeSeriesTooltip: makeSeriesTooltip13 } = import_ag_charts_community97._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId11, Group: Group8, Selection: Selection7, PointerEvents: PointerEvents6 } = import_ag_charts_community98._ModuleSupport;
...
var { mapLineBackgroundSeriesThemeableOptionsDef } = import_ag_charts_community99._ModuleSupport;
...
function polygonPointSearch(polygons, precision, valueFn) {
  ...
  while (queue != null) {
    ...
    queue = (0, import_ag_charts_core35.insertListItemsSorted)(queue, newLabelPlacements, labelPlacementCmp);
  }
  if (bestResult == null)
    return;
...
var { BBox: BBox11 } = import_ag_charts_community100._ModuleSupport;
...
var { Property: Property27, SeriesProperties: SeriesProperties5, makeSeriesTooltip: makeSeriesTooltip14, Label: Label9 } = import_ag_charts_community101._ModuleSupport;
...
var MapMarkerSeries = class extends TopologySeries {
  ...
  createNodeData() {
    ...
    if (dataModel == null || processedData == null || scale == null)
      return;
    const hasLatLon = latitudeKey != null && longitudeKey != null;
    const idValues = idKey == null ? void 0 : dataModel.resolveColumnById(this, `idValue`, processedData);
    const featureValues = idKey == null ? void 0 : dataModel.resolveColumnById(this, `featureValue`, processedData);
    const latValues = hasLatLon ? dataModel.resolveColumnById(this, `latValue`, processedData) : void 0;
    const lonValues = hasLatLon ? dataModel.resolveColumnById(this, `lonValue`, processedData) : void 0;
    const labelValues = labelKey == null ? void 0 : dataModel.resolveColumnById(this, `labelValue`, processedData);
    ...
    const measurer = (0, import_ag_charts_core36.cachedTextMeasurer)(label);
    ...
    for (const [datumIndex, datum] of rawData.entries()) {
      ...
      const projectedGeometry = idValue == null ? void 0 : projectedGeometries?.get(idValue);
    ...
    if (missingGeometries.length > 0) {
      import_ag_charts_core36.Logger.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = import_ag_charts_community102._ModuleSupport.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs12, mapMarkerSeriesThemeableOptionsDef, without: without6 } = import_ag_charts_community103._ModuleSupport;
var mapMarkerSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core37.required)((0, import_ag_charts_core37.constant)("map-marker")),
  idKey: import_ag_charts_core37.string,
  latitudeKey: import_ag_charts_core37.string,
  longitudeKey: import_ag_charts_core37.string,
  sizeKey: import_ag_charts_core37.string,
  colorKey: import_ag_charts_core37.string,
  labelKey: import_ag_charts_core37.string,
  idName: import_ag_charts_core37.string,
  latitudeName: import_ag_charts_core37.string,
  longitudeName: import_ag_charts_core37.string,
  sizeName: import_ag_charts_core37.string,
  colorName: import_ag_charts_core37.string,
  labelName: import_ag_charts_core37.string,
  topology: import_ag_charts_core37.geoJson,
  topologyIdKey: import_ag_charts_core37.string,
  legendItemName: import_ag_charts_core37.string,
  title: import_ag_charts_core37.string
};
    ...
    series: {
      ...
      fill: applyMapPalette({
        $applySwitch: [
          { $path: "type" },
          { $mapPalette: "fill" },
          ["gradient", import_ag_charts_community104._ModuleSupport.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS],
          ["image", import_ag_charts_community104._ModuleSupport.FILL_IMAGE_DEFAULTS],
          ["pattern", import_ag_charts_community104._ModuleSupport.FILL_PATTERN_DEFAULTS]
        ]
      }),
      ...
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(import_ag_charts_community104._ModuleSupport.SAFE_RANGE2_OPERATION)
        ]
      },
      fillOpacity: 0.5,
      label: {
        ...import_ag_charts_community104._ModuleSupport.LABEL_BOXING_DEFAULTS,
        enabled: false,
        fontSize: { $ref: "fontSize" },
        fontFamily: { $ref: "fontFamily" },
        fontWeight: { $ref: "fontWeight" },
...
var MapMarkerSeriesModule = {
  ...
  validate(options, optionsDefs2, path) {
    const result = (0, import_ag_charts_core38.validate)(options, optionsDefs2, path);
    ...
    if (cleared?.idKey == null && (cleared?.latitudeKey == null || cleared?.longitudeKey == null)) {
      ...
      invalid.push(new import_ag_charts_core38.ValidationError("required", message, null, path));
    }
    return result;
  }
};
...
var { Property: Property28, SeriesProperties: SeriesProperties6, makeSeriesTooltip: makeSeriesTooltip15 } = import_ag_charts_community105._ModuleSupport;
...
var fixedScale = import_ag_charts_community106._ModuleSupport.MercatorScale.fixedScale();
var MapShapeSeries = class extends TopologySeries {
  ...
  async processData(dataController) {
    ...
    if (topology == null) {
      import_ag_charts_core39.Logger.warnOnce(`no topology was provided for [MapShapeSeries]; nothing will be rendered.`);
    }
  }
  isColorScaleValid() {
    const { colorKey } = this.properties;
  ...
  getLabelLayout(datum, labelValue, measurer, geometry, previousLabelLayout) {
    ...
    if (labelText == null)
      return;
    const baseSize = (0, import_ag_charts_core39.isArray)(labelText) ? (0, import_ag_charts_core39.measureTextSegments)(labelText, label) : measurer.measureLines(String(labelText));
  ...
  getLabelDatum(labelLayout, scaling) {
    ...
    const labelFormatting = formatSingleLabel(
      (0, import_ag_charts_core39.toPlainText)(labelText),
      label,
      { padding },
  ...
  createNodeData() {
    ...
    const labelValues = labelKey == null ? void 0 : dataModel.resolveColumnById(this, `labelValue`, processedData);
    const colorValues = colorKey == null ? void 0 : dataModel.resolveColumnById(this, `colorValue`, processedData);
    const measurer = (0, import_ag_charts_core39.cachedTextMeasurer)(label);
    ...
    if (missingGeometries.length > 0) {
      import_ag_charts_core39.Logger.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs13, mapShapeSeriesThemeableOptionsDef, without: without7 } = import_ag_charts_community107._ModuleSupport;
var mapShapeSeriesOptionsDef = {
  ...without7(commonSeriesOptionsDefs13, ["highlightStyle", "highlight"]),
  ...mapShapeSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core40.required)((0, import_ag_charts_core40.constant)("map-shape")),
  idKey: (0, import_ag_charts_core40.required)(import_ag_charts_core40.string),
  colorKey: import_ag_charts_core40.string,
  labelKey: import_ag_charts_core40.string,
  idName: import_ag_charts_core40.string,
  colorName: import_ag_charts_core40.string,
  labelName: import_ag_charts_core40.string,
  topology: import_ag_charts_core40.geoJson,
  topologyIdKey: import_ag_charts_core40.string,
  legendItemName: import_ag_charts_core40.string,
  title: import_ag_charts_core40.string
};
    ...
    series: {
      fill: applyMapPalette({
        $applySwitch: [
          { $path: "type" },
          { $mapPalette: "fill" },
          ["gradient", import_ag_charts_community108._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS],
          ["image", import_ag_charts_community108._ModuleSupport.FILL_IMAGE_DEFAULTS],
          ["pattern", import_ag_charts_community108._ModuleSupport.FILL_PATTERN_DEFAULTS]
        ]
      }),
      ...
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(import_ag_charts_community108._ModuleSupport.SAFE_RANGE2_OPERATION)
        ]
      },
      fillOpacity: 1,
      strokeWidth: 1,
      ...
      padding: 2,
      label: {
        ...import_ag_charts_community108._ModuleSupport.LABEL_BOXING_DEFAULTS,
        color: { $ref: "chartBackgroundColor" },
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
        fontWeight: "bold",
      ...
      highlight: applyMapPalette(import_ag_charts_community108._ModuleSupport.multiSeriesHighlightStyle(true))
    },
    tooltip: {
      range: "exact"
    }
...
var { Property: Property29, SeriesProperties: SeriesProperties7, makeSeriesTooltip: makeSeriesTooltip16 } = import_ag_charts_community109._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId14, Selection: Selection10, Group: Group11, PointerEvents: PointerEvents8 } = import_ag_charts_community110._ModuleSupport;
var MapShapeBackgroundSeries = class extends TopologySeries {
  ...
  processData() {
    ...
    if (topology == null) {
      import_ag_charts_core41.Logger.warnOnce(`no topology was provided for [MapShapeBackgroundSeries]; nothing will be rendered.`);
    }
  }
  createNodeData() {
    const { id: seriesId, topology, scale, properties } = this;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs14, mapShapeBackgroundSeriesThemeableOptionsDef } = import_ag_charts_community111._ModuleSupport;
var mapShapeBackgroundSeriesOptionsDef = {
  ...mapShapeBackgroundSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs14,
  type: (0, import_ag_charts_core42.required)((0, import_ag_charts_core42.constant)("map-shape-background")),
  topology: import_ag_charts_core42.geoJson
};
    ...
    series: {
      fill: applyMapPalette({
        $applySwitch: [
          ...
          ["gradient", import_ag_charts_community112._ModuleSupport.FILL_GRADIENT_LINEAR_HIERARCHY_DEFAULTS],
          ["image", import_ag_charts_community112._ModuleSupport.FILL_IMAGE_DEFAULTS],
          ["pattern", import_ag_charts_community112._ModuleSupport.FILL_PATTERN_HIERARCHY_DEFAULTS]
        ]
      }),
      stroke: { $ref: "chartBackgroundColor" },
      strokeWidth: 1
...
var { createDatumId: createDatumId15, mergeDefaults: mergeDefaults14, toHighlightString: toHighlightString4 } = import_ag_charts_community113._ModuleSupport;
function makeStylerParams(series, highlighted, highlightStateEnum) {
  ...
  const highlightState = toHighlightString4(highlightStateEnum ?? import_ag_charts_community113._ModuleSupport.HighlightState.None);
  return {
    angleKey,
    cornerRadius,
    fill,
...
function getStyle(series, ignoreStylerCallback, highlighted, highlightState) {
...
function getItemStyle(series, nodeDatum, isHighlight, highlightState) {
  ...
  const baseStyle = mergeDefaults14(
    highlightStyle,
    getStyle(series, nodeDatum === void 0, isHighlight, highlightState)
  );
  let style = baseStyle;
  if (itemStyler != null && nodeDatum != null) {
    const overrides = series.cachedDatumCallback(
      createDatumId15(series.getDatumId(nodeDatum), isHighlight ? "highlight" : "node"),
      () => {
...
var RadialColumnSeriesNodeEvent = class extends import_ag_charts_community114._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends import_ag_charts_community114._ModuleSupport.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
  ...
  async processData(dataController) {
    ...
    const extraProps = [];
    if ((0, import_ag_charts_core43.isDefined)(normalizedTo)) {
  ...
  legendItemSymbol() {
    const { fill, stroke, fillOpacity, strokeOpacity, strokeWidth, lineDash, lineDashOffset } = getStyle(
      ...
      false,
      false,
      import_ag_charts_community114._ModuleSupport.HighlightState.None
    );
    const markerStyle = {
    ...
    if (import_ag_charts_community114._ModuleSupport.isGradientFill(markerStyle.fill)) {
  ...
  getDatumId(datum) {
    return createDatumId16(datum.angleValue);
  }
  computeLabelsBBox() {
    return null;
  }
...
var { SeriesProperties: SeriesProperties8, makeSeriesTooltip: makeSeriesTooltip17, Property: Property30, Label: Label10 } = import_ag_charts_community115._ModuleSupport;
...
var { motion: motion7 } = import_ag_charts_community116._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion8 } = import_ag_charts_community117._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2, PolarZIndexMap } = import_ag_charts_community118._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs15, nightingaleSeriesThemeableOptionsDef } = import_ag_charts_community119._ModuleSupport;
var nightingaleSeriesOptionsDef = {
  ...commonSeriesOptionsDefs15,
  ...nightingaleSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core44.required)((0, import_ag_charts_core44.constant)("nightingale")),
  angleKey: (0, import_ag_charts_core44.required)(import_ag_charts_core44.string),
  radiusKey: (0, import_ag_charts_core44.required)(import_ag_charts_core44.string),
  angleName: import_ag_charts_core44.string,
  radiusName: import_ag_charts_core44.string,
  legendItemName: import_ag_charts_core44.string,
  grouped: import_ag_charts_core44.boolean,
  stacked: import_ag_charts_core44.boolean,
  stackGroup: import_ag_charts_core44.string,
  normalizedTo: import_ag_charts_core44.number
};
...
var NIGHTINGALE_SERIES_THEME = {
  series: {
    ...
    strokeWidth: 1,
    label: {
      ...import_ag_charts_community120._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
...
var { SeriesProperties: SeriesProperties9, makeSeriesTooltip: makeSeriesTooltip18, Property: Property31, Label: Label11, DropShadow: DropShadow5 } = import_ag_charts_community122._ModuleSupport;
...
var PyramidSeries = class extends import_ag_charts_community123._ModuleSupport.DataModelSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: void 0,
  ...
  createNodeData() {
    ...
    const textMeasurer = (0, import_ag_charts_core45.cachedTextMeasurer)(stageLabel);
    let textAlign;
    let textBaseline;
    if (horizontal) {
      textAlign = "center";
    ...
    for (const [datumIndex, datum] of rawData.entries()) {
      ...
      const { width, height } = (0, import_ag_charts_core45.isArray)(text) ? (0, import_ag_charts_core45.measureTextSegments)(text, label) : textMeasurer.measureLines(text);
  ...
  getItemStyle({ datumIndex, datum }, isHighlight) {
    ...
    if (itemStyler != null && datumIndex != null) {
      const overrides = this.cachedDatumCallback(
        createDatumId17(datumIndex, isHighlight ? "highlight" : "node"),
        () => {
          const params = this.makeItemStylerParams(datum, datumIndex, isHighlight, style);
          return this.callWithContext(itemStyler, params);
        }
  ...
  getTooltipContent(datumIndex) {
    ...
    return this.formatTooltipWithContext(
      ...
      {
        symbol: this.legendItemSymbol(datumIndex),
        data: [{ label: (0, import_ag_charts_core45.toPlainText)(label), value: (0, import_ag_charts_core45.toPlainText)(value) }]
      },
      {
        seriesId,
        datum,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs16, pyramidSeriesThemeableOptionsDef } = import_ag_charts_community124._ModuleSupport;
var pyramidSeriesOptionsDef = {
  ...pyramidSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs16,
  type: (0, import_ag_charts_core46.required)((0, import_ag_charts_core46.constant)("pyramid")),
  stageKey: (0, import_ag_charts_core46.required)(import_ag_charts_core46.string),
  valueKey: (0, import_ag_charts_core46.required)(import_ag_charts_core46.string)
};
...
var PYRAMID_SERIES_THEME = {
  series: {
    ...
    // @ts-expect-error undocumented option
    highlight: import_ag_charts_community125._ModuleSupport.singleSeriesHighlightStyle()
  }
};
...
var BASE_RADAR_SERIES_THEME = {
  series: {
    stroke: { $palette: "stroke" },
    label: {
      ...import_ag_charts_community126._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    marker: {
      ...
      fill: {
        $applySwitch: [
          { $path: "type" },
          { $palette: "fill" },
          ["gradient", import_ag_charts_community126._ModuleSupport.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS],
          ["image", import_ag_charts_community126._ModuleSupport.FILL_IMAGE_DEFAULTS],
          ["pattern", import_ag_charts_community126._ModuleSupport.FILL_PATTERN_DEFAULTS]
        ]
      },
      stroke: { $palette: "stroke" },
      fillOpacity: 1,
    ...
    highlight: import_ag_charts_community126._ModuleSupport.multiSeriesHighlightStyle(),
    tooltip: {
      range: { $path: ["/tooltip/range", "nearest"] }
    }
  },
...
var RADAR_LINE_SERIES_THEME = import_ag_charts_community126._ModuleSupport.mergeDefaults(
  {
    series: {
      stroke: import_ag_charts_community126._ModuleSupport.SAFE_STROKE_FILL_OPERATION,
      strokeWidth: 2
    }
  },
  BASE_RADAR_SERIES_THEME
);
var RADAR_AREA_SERIES_THEME = import_ag_charts_community126._ModuleSupport.mergeDefaults(
  {
    series: {
      fill: {
        $applySwitch: [
          { $path: "type" },
          { $palette: "fill" },
          ["gradient", import_ag_charts_community126._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS],
          ["image", import_ag_charts_community126._ModuleSupport.FILL_IMAGE_DEFAULTS],
          ["pattern", import_ag_charts_community126._ModuleSupport.FILL_PATTERN_DEFAULTS]
        ]
      },
...
var { Label: Label12, SeriesMarker: SeriesMarker2, SeriesProperties: SeriesProperties10, makeSeriesTooltip: makeSeriesTooltip19, Property: Property32 } = import_ag_charts_community127._ModuleSupport;
...
var RadarSeriesNodeEvent = class extends import_ag_charts_community128._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends import_ag_charts_community128._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: "angleValue",
  ...
  createNodeData() {
    ...
    const nodeData = rawData.map((datum, datumIndex) => {
      ...
      if (label.enabled) {
        ...
        if (labelText) {
          let textAlign = "right";
          if ((0, import_ag_charts_core47.isNumberEqual)(cos, 0)) {
            textAlign = "center";
          } else if (cos > 0) {
            textAlign = "left";
          }
          let textBaseline = "bottom";
          if ((0, import_ag_charts_core47.isNumberEqual)(sin, 0)) {
            textBaseline = "middle";
          } else if (sin > 0) {
            textBaseline = "top";
          }
      ...
      return {
        ...
        angleValue: angleDatum,
        radiusValue: radiusDatum,
        missing: !(0, import_ag_charts_core47.isFiniteNumber)(angle) || !(0, import_ag_charts_core47.isFiniteNumber)(radius)
      };
    });
    return {
      itemId: radiusKey,
  ...
  getPathNodesStyle() {
    ...
    return mergeDefaults16(highlightStyle, stylerStyle);
  }
  getLinePoints() {
  ...
  getStylerResult(stylerResult, highlighted, highlightState) {
...
var { Property: Property33 } = import_ag_charts_community129._ModuleSupport;
...
var {
  ...
  toHighlightString: toHighlightString5
...
var RadarAreaSeries = class extends RadarSeries {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof import_ag_charts_community130._ModuleSupport.PolarAxis ? axis : void 0;
    };
  ...
  makeStylerParams(highlighted, highlightStateEnum) {
    const { properties } = this;
    const highlightState = toHighlightString5(highlightStateEnum ?? HighlightState4.None);
    return {
      marker: {
  ...
  getStyle(highlighted, highlightState) {
    const { marker, fill, fillOpacity, lineDash, lineDashOffset, stroke, strokeOpacity, strokeWidth } = this.properties;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs17, radarAreaSeriesThemeableOptionsDef } = import_ag_charts_community131._ModuleSupport;
var radarAreaSeriesOptionsDef = {
  ...commonSeriesOptionsDefs17,
  ...radarAreaSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core48.required)((0, import_ag_charts_core48.constant)("radar-area")),
  ...
  legendItemName: import_ag_charts_core48.string
};
...
var { HighlightState: HighlightState5, PointerEvents: PointerEvents11, toHighlightString: toHighlightString6 } = import_ag_charts_community133._ModuleSupport;
var RadarLineSeries = class extends RadarSeries {
  ...
  makeStylerParams(highlighted, highlightStateEnum) {
    const { properties } = this;
    const highlightState = toHighlightString6(highlightStateEnum ?? HighlightState5.None);
    return {
      marker: {
        fill: properties.marker.fill,
        fillOpacity: properties.marker.fillOpacity,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs18, radarLineSeriesThemeableOptionsDef } = import_ag_charts_community134._ModuleSupport;
var radarLineSeriesOptionsDef = {
  ...commonSeriesOptionsDefs18,
  ...radarLineSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core49.required)((0, import_ag_charts_core49.constant)("radar-line")),
  ...
  legendItemName: import_ag_charts_core49.string
};

// packages/ag-charts-enterprise/src/series/radar-line/radarLineModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE5 } = import_ag_charts_community135._ModuleSupport.ThemeConstants;
var RadarLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { SeriesProperties: SeriesProperties11, makeSeriesTooltip: makeSeriesTooltip20, Property: Property34, Label: Label13 } = import_ag_charts_community136._ModuleSupport;
...
var { SectorBox: SectorBox3, motion: motion9 } = import_ag_charts_community137._ModuleSupport;
...
var RadialBarSeriesNodeEvent = class extends import_ag_charts_community138._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends import_ag_charts_community138._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async processData(dataController) {
    ...
    const stackGroupTrailingId = `${stackGroupId}-trailing`;
    const extraProps = [];
    if ((0, import_ag_charts_core50.isDefined)(normalizedTo)) {
  ...
  updateSectorSelection(selection, isHighlight) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      const fill = style.fill;
      const fillParams = import_ag_charts_community138._ModuleSupport.isGradientFill(fill) && fill.bounds !== "item" ? { centerX: 0, centerY: 0 } : void 0;
  ...
  legendItemSymbol() {
    const { fill, stroke, fillOpacity, strokeOpacity, strokeWidth, lineDash, lineDashOffset } = getStyle(
      ...
      false,
      false,
      import_ag_charts_community138._ModuleSupport.HighlightState.None
    );
    const markerStyle = {
      fill: fill ?? "rgba(0, 0, 0, 0)",
      stroke: stroke ?? "rgba(0, 0, 0, 0)",
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs19, radialBarSeriesThemeableOptionsDef } = import_ag_charts_community139._ModuleSupport;
var radialBarSeriesOptionsDef = {
  ...commonSeriesOptionsDefs19,
  ...radialBarSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core51.required)((0, import_ag_charts_core51.constant)("radial-bar")),
  ...
  legendItemName: import_ag_charts_core51.string,
...
var {
  ...
  FILL_PATTERN_DEFAULTS: FILL_PATTERN_DEFAULTS3
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    strokeWidth: { $isUserOption: ["./stroke", 1, 0] },
    label: {
      ...import_ag_charts_community140._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
...
// packages/ag-charts-enterprise/src/series/radial-bar/radialBarModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE7 } = import_ag_charts_community141._ModuleSupport.ThemeConstants;
var RadialBarModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { Property: Property35 } = import_ag_charts_community142._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection20, PolarAxis: PolarAxis4, RadialColumnShape, getRadialColumnWidth } = import_ag_charts_community143._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs20, radialColumnSeriesThemeableOptionsDef } = import_ag_charts_community144._ModuleSupport;
var radialColumnSeriesOptionsDef = {
  ...commonSeriesOptionsDefs20,
  ...radialColumnSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core52.required)((0, import_ag_charts_core52.constant)("radial-column")),
  angleKey: (0, import_ag_charts_core52.required)(import_ag_charts_core52.string),
  radiusKey: (0, import_ag_charts_core52.required)(import_ag_charts_core52.string),
  angleName: import_ag_charts_core52.string,
  radiusName: import_ag_charts_core52.string,
  legendItemName: import_ag_charts_core52.string,
  grouped: import_ag_charts_core52.boolean,
  stacked: import_ag_charts_core52.boolean,
  stackGroup: import_ag_charts_core52.string,
  normalizedTo: import_ag_charts_core52.number
};
...
var RADIAL_COLUMN_SERIES_THEME = {
  series: {
    ...
    strokeWidth: { $isUserOption: ["./stroke", 1, 0] },
    label: {
      ...import_ag_charts_community145._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: import_ag_charts_community145._ModuleSupport.multiSeriesHighlightStyle()
  },
  axes: {
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE9 } = import_ag_charts_community146._ModuleSupport.ThemeConstants;
...
var { SvgPath, Rotatable, Translatable, Scalable: Scalable2 } = import_ag_charts_community147._ModuleSupport;
...
var { getColorStops: getColorStops2, normalizeAngle360: normalizeAngle3606, normalizeAngle360Inclusive: normalizeAngle360Inclusive2, toDegrees } = import_ag_charts_community148._ModuleSupport;
var { BaseProperties: BaseProperties11, makeSeriesTooltip: makeSeriesTooltip21, SeriesProperties: SeriesProperties12, PropertiesArray: PropertiesArray3, AxisLabel: AxisLabel4, Property: Property36, Label: Label14 } = import_ag_charts_community148._ModuleSupport;
...
var RadialGaugeTargetProperties = class extends BaseProperties11 {
  constructor() {
    super(...arguments);
...
var RadialGaugeBarProperties = class extends BaseProperties11 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.fills = new PropertiesArray3(import_ag_charts_community148._ModuleSupport.StopProperties);
    this.fillMode = "continuous";
    this.fillOpacity = 1;
    this.stroke = "black";
    this.strokeWidth = 0;
...
var RadialGaugeScaleIntervalProperties = class extends BaseProperties11 {
  constructor() {
    super(...arguments);
    this.values = void 0;
    this.step = void 0;
...
var RadialGaugeScaleProperties = class extends BaseProperties11 {
  constructor() {
    super(...arguments);
    this.min = 0;
    this.max = 1;
...
var RadialGaugeNeedleProperties = class extends BaseProperties11 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.spacing = 0;
...
var { SectorBox: SectorBox5 } = import_ag_charts_community149._ModuleSupport;
...
function formatRadialGaugeLabels(series, ctx, selection, opts, innerRadius, datumOverrides) {
  ...
  if (secondaryLabelDatum != null && secondaryLabelText != null) {
    const layout = formatStackedLabels(
      (0, import_ag_charts_core53.toPlainText)(labelText),
      labelDatum,
      (0, import_ag_charts_core53.toPlainText)(secondaryLabelText),
      secondaryLabelDatum,
      params,
      sizeFittingHeight
    );
    ...
    const layout = formatSingleLabel((0, import_ag_charts_core53.toPlainText)(labelText), labelDatum, params, sizeFittingHeight);
...
var RadialGaugeSeries = class extends import_ag_charts_community150._ModuleSupport.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
    ...
    this.tickSelection = Selection14.select(this.tickGroup, import_ag_charts_community150._ModuleSupport.TransformableText);
    this.datumUnion = new DatumUnion();
  ...
  layoutScale() {
    ...
    const measurer = (0, import_ag_charts_core54.cachedTextMeasurer)(label);
    const tickData = ticks.map((value, index) => {
      ...
      if (text == null)
        return;
      const { width, height } = (0, import_ag_charts_core54.isArray)(text) ? (0, import_ag_charts_core54.measureTextSegments)(text, label) : measurer.measureLines(text);
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((sector, datum) => {
      ...
      sector.pointerEvents = this.properties.bar.enabled ? import_ag_charts_community150._ModuleSupport.PointerEvents.All : import_ag_charts_community150._ModuleSupport.PointerEvents.None;
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, import_ag_charts_community150._ModuleSupport.Sector, (node, first, last) => {
      ...
      node.pointerEvents = import_ag_charts_community150._ModuleSupport.PointerEvents.None;
    });
  }
  updateScaleSelection(opts) {
    return opts.scaleSelection.update(opts.scaleData, void 0, (datum) => {
  ...
  updateNeedleSelection(opts) {
    return opts.needleSelection.update(opts.needleData, void 0, () => createDatumId19(0));
  }
  ...
  getTargetStyle(isHighlight, { datumIndex, style }) {
    const highlightStyle = this.getHighlightStyle(isHighlight, datumIndex);
    return mergeDefaults17(highlightStyle, {
      ...style,
      opacity: 1
    });
  }
  ...
  getCaptionText() {
    ...
    this.labelSelection.each((_label, datum) => {
      ...
      if (text != null) {
        description.push((0, import_ag_charts_core54.toPlainText)(text));
      }
    });
...
// packages/ag-charts-enterprise/src/series/radial-gauge/radialGaugeModule.ts
var { FONT_SIZE_RATIO } = import_ag_charts_community151._ModuleSupport;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $interpolate: [{ $palette: "secondDivergingColors" }, 5] },
          import_ag_charts_community151._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        defaultFill: { $path: ["/1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        stroke: { $path: ["/2", import_ag_charts_community151._ModuleSupport.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
        label: {
          fontWeight: { $ref: "fontWeight" },
      ...
      label: {
        ...import_ag_charts_community151._ModuleSupport.LABEL_BOXING_DEFAULTS,
        enabled: true,
        fontWeight: { $ref: "fontWeight" },
        fontSize: 56,
...
var RadialGaugeSeriesModule = {
  ...
  chartType: "standalone",
  enterprise: true,
  options: import_ag_charts_community151._ModuleSupport.radialGaugeSeriesOptionsDef,
...
var { BBox: BBox15, Path: Path12, Vec2, SceneChangeDetection: SceneChangeDetection7 } = import_ag_charts_community152._ModuleSupport;
...
function lerpClamp(a, b, ratio3) {
  return (0, import_ag_charts_core55.clamp)(a, (b - a) * ratio3 + a, b);
}
...
var SankeySeriesLinkProperties = class extends BaseProperties12 {
  constructor() {
    super(...arguments);
    this.fill = void 0;
    this.fillOpacity = 1;
...
var SankeySeriesNodeProperties = class extends BaseProperties12 {
  constructor() {
    super(...arguments);
    this.spacing = 1;
    this.minSpacing = 0;
...
var SankeySeries = class extends FlowProportionSeries {
  ...
  createNodeData() {
    ...
    for (const graphNode of nodeGraph.values()) {
      ...
      node.label = (0, import_ag_charts_core56.toPlainText)(labelText);
      column.nodes.push(graphNode);
      column.size += size;
      graphNode.columnIndex = column.index;
    }
    const measurer = (0, import_ag_charts_core56.cachedTextMeasurer)(this.properties.label);
      ...
      if (labelPlacement == null && edgeLabelPlacement == null) {
        ...
        const reduceLabelWidthFn = (acc, n) => {
          ...
          if (labelPlacement === "center" && edgeLabelPlacement == null)
            maxWidth /= 2;
          const text = (0, import_ag_charts_core56.wrapText)(node.datum.label, {
            maxWidth,
      ...
      for (const node of column.nodes) {
        ...
        node.weight += node.linksBefore.reduce((acc, before) => {
          if (before.node.columnIndex !== column.index - 1)
            return acc;
          const weight = before.node.datum.size / columns[before.node.columnIndex].size * columnWeights[before.node.columnIndex];
          return Math.max(acc, weight);
        }, 0);
        node.weight += node.linksAfter.reduce((acc, after) => {
          if (after.node.columnIndex !== column.index + 1)
            return acc;
          const weight = after.node.datum.size / columns[after.node.columnIndex].size * columnWeights[after.node.columnIndex];
          return Math.max(acc, weight);
        }, 0);
      }
    ...
    if (sizeScale < 0) {
      import_ag_charts_core56.Logger.warnOnce(
    ...
    for (const [index, column] of columns.entries()) {
      ...
      for (const n of column.nodes) {
        ...
        let text;
        if (!leading && !trailing) {
          const lineHeight = (0, import_ag_charts_core56.calcLineHeight)(fontSize);
          ...
          text = (0, import_ag_charts_core56.wrapText)(node.label, {
            maxWidth,
  ...
  updateNodeSelection(opts) {
    return opts.datumSelection.update(opts.nodeData, void 0, (datum) => createDatumId20(datum.type, datum.id));
  }
  getNodeStyle(nodeDatum, fromNodeDatumIndex, isHighlight) {
    const { properties } = this;
    const {
    ...
    const highlightStyle = this.getHighlightStyle(isHighlight, nodeDatum.datumIndex);
    const baseStyle = mergeDefaults18(highlightStyle, properties.getStyle(false, fills, strokes, fromNodeDatumIndex));
    ...
    if (itemStyler != null && nodeDatum.datumIndex != null) {
      const overrides = this.cachedDatumCallback(
        createDatumId20(nodeDatum.datumIndex.index, "node", isHighlight ? "highlight" : "node"),
        () => {
          const params = this.makeItemStylerParams(nodeDatum, isHighlight, style);
          return this.callWithContext(itemStyler, params);
        }
  ...
  updateLinkSelection(opts) {
    return opts.datumSelection.update(
      opts.nodeData,
      void 0,
      (datum) => createDatumId20(datum.type, datum.index, datum.fromNode.id, datum.toNode.id)
    );
  }
  getLinkStyle({ datumIndex, datum }, fromNodeDatumIndex, isHighlight) {
    const { id: seriesId, properties } = this;
    ...
    const highlightStyle = this.getHighlightStyle(isHighlight, datumIndex);
    const baseStyle = mergeDefaults18(
      highlightStyle,
    ...
    if (itemStyler != null && datumIndex != null) {
      const overrides = this.cachedDatumCallback(
        createDatumId20(datumIndex.index, "link", isHighlight ? "highlight" : "node"),
        () => {
          const activeHighlight = this.ctx.highlightManager?.getActiveHighlight();
          const highlightState = this.getHighlightStateString(activeHighlight, isHighlight, datumIndex);
          return this.callWithContext(itemStyler, {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs21, sankeySeriesThemeableOptionsDef } = import_ag_charts_community155._ModuleSupport;
var sankeySeriesOptionsDef = {
  ...sankeySeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs21,
  type: (0, import_ag_charts_core57.required)((0, import_ag_charts_core57.constant)("sankey")),
  fromKey: (0, import_ag_charts_core57.required)(import_ag_charts_core57.string),
  toKey: (0, import_ag_charts_core57.required)(import_ag_charts_core57.string),
  sizeKey: import_ag_charts_core57.string,
  sizeName: import_ag_charts_core57.string
};
sankeySeriesOptionsDef.fillGradientDefaults = (0, import_ag_charts_core57.undocumented)(import_ag_charts_core57.fillGradientDefaults);
sankeySeriesOptionsDef.fillPatternDefaults = (0, import_ag_charts_core57.undocumented)(import_ag_charts_core57.fillPatternDefaults);
sankeySeriesOptionsDef.fillImageDefaults = (0, import_ag_charts_core57.undocumented)(import_ag_charts_core57.fillImageDefaults);
sankeySeriesOptionsDef.defaultColorRange = (0, import_ag_charts_core57.undocumented)((0, import_ag_charts_core57.arrayOf)((0, import_ag_charts_core57.arrayOf)(import_ag_charts_core57.color)));
sankeySeriesOptionsDef.defaultPatternFills = (0, import_ag_charts_core57.undocumented)((0, import_ag_charts_core57.arrayOf)(import_ag_charts_core57.color));
...
var SankeyModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      strokes: { $palette: "strokes" },
      // @ts-expect-error undocumented option
      fillGradientDefaults: import_ag_charts_community156._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
      fillPatternDefaults: import_ag_charts_community156._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community156._ModuleSupport.FILL_IMAGE_DEFAULTS,
      defaultColorRange: { $palette: "gradients" },
      defaultPatternFills: import_ag_charts_community156._ModuleSupport.SAFE_FILLS_OPERATION,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
      ...
      highlight: {
        ...import_ag_charts_community156._ModuleSupport.singleSeriesHighlightStyle()
      },
      label: {
        ...import_ag_charts_community156._ModuleSupport.LABEL_BOXING_DEFAULTS,
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
        fontWeight: { $ref: "fontWeight" },
        color: { $ref: "textColor" },
...
var { HierarchySeriesProperties, HighlightStyle, makeSeriesTooltip: makeSeriesTooltip23, Property: Property38 } = import_ag_charts_community157._ModuleSupport;
...
var SunburstNode = class extends import_ag_charts_community158._ModuleSupport.HierarchyNode {
  constructor() {
    super(...arguments);
    this.label = void 0;
...
var SunburstSeries = class extends import_ag_charts_community158._ModuleSupport.HierarchySeries {
  constructor(moduleCtx) {
    super(moduleCtx);
  ...
  getItemStyle(nodeDatum, isHighlight) {
    ...
    const baseStyle = mergeDefaults19(highlightStyle, properties.getStyle(rootIndex));
    ...
    if (itemStyler != null && nodeDatum != null) {
      ...
      if (overrides) {
        style = mergeDefaults19(overrides, style);
      }
    }
    return style;
  }
  makeItemStylerParams(nodeDatum, isHighlight, style) {
    const { id: seriesId } = this;
    const activeHighlight = this.ctx.highlightManager?.getActiveHighlight();
  ...
  updateNodes() {
    ...
    this.rootNode?.walk((node) => {
      ...
      const formatting = formatLabels(
        (0, import_ag_charts_core58.toPlainText)(labelValue),
        this.properties.label,
        (0, import_ag_charts_core58.toPlainText)(secondaryLabelValue),
        this.properties.secondaryLabel,
        { padding },
        sizeFittingHeight
      );
    ...
    const updateSector = (nodeDatum, sector, highlighted) => {
      ...
      const fillBBox = import_ag_charts_community158._ModuleSupport.isGradientFill(fill) && fill.bounds !== "item" ? seriesFillBBox : void 0;
    ...
    const highlightedDatum = this.ctx.highlightManager?.getActiveHighlight();
    for (const text of this.labelSelection.selectByClass(TransformableText3)) {
  ...
  getTooltipContent(datumIndex) {
    ...
    if (import_ag_charts_community158._ModuleSupport.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
    return this.formatTooltipWithContext(
      tooltip,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs22, sunburstSeriesThemeableOptionsDef, without: without8 } = import_ag_charts_community159._ModuleSupport;
var sunburstSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core59.required)((0, import_ag_charts_core59.constant)("sunburst")),
  labelKey: import_ag_charts_core59.string,
  secondaryLabelKey: import_ag_charts_core59.string,
  childrenKey: import_ag_charts_core59.string,
  sizeKey: import_ag_charts_core59.string,
  colorKey: import_ag_charts_core59.string,
  sizeName: import_ag_charts_core59.string,
  colorName: import_ag_charts_core59.string
};

// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { BASE_FONT_SIZE, FONT_SIZE_RATIO: FONT_SIZE_RATIO2 } = import_ag_charts_community160._ModuleSupport;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
        ...
        $applyCycle: [
          ...
          { $palette: "fills" },
          {
            $applySwitch: [
              { $path: ["/type", void 0, { $value: "$1" }] },
              { $value: "$1" },
              ["gradient", import_ag_charts_community160._ModuleSupport.FILL_GRADIENT_RADIAL_REVERSED_SERIES_DEFAULTS],
              ["pattern", import_ag_charts_community160._ModuleSupport.FILL_PATTERN_DEFAULTS],
              ["image", import_ag_charts_community160._ModuleSupport.FILL_IMAGE_DEFAULTS]
            ]
          }
        ]
      },
      ...
      strokeWidth: { $isUserOption: ["./strokes/0", 2, 0] },
      label: {
        ...import_ag_charts_community160._ModuleSupport.LABEL_BOXING_DEFAULTS,
        fontFamily: { $ref: "fontFamily" },
    ...
    gradientLegend: {
      enabled: true,
      ...import_ag_charts_community160._ModuleSupport.LEGEND_CONTAINER_THEME
    }
  }
};
...
var { BaseProperties: BaseProperties13, HierarchySeriesProperties: HierarchySeriesProperties2, HighlightStyle: HighlightStyle2, makeSeriesTooltip: makeSeriesTooltip24, Property: Property39, Label: Label16 } = import_ag_charts_community161._ModuleSupport;
...
var TreemapSeriesGroup = class extends BaseProperties13 {
  constructor() {
    super(...arguments);
    this.fill = void 0;
    this.fillOpacity = 1;
...
var TreemapSeriesTile = class extends BaseProperties13 {
  constructor() {
    super(...arguments);
    this.fill = void 0;
    this.fillOpacity = 1;
...
var TreemapSeriesGroupHighlightStyle = class extends BaseProperties13 {
  constructor() {
    super(...arguments);
    this.label = new AutoSizedLabel();
  }
...
var TreemapSeriesTileHighlightStyle = class extends BaseProperties13 {
  constructor() {
    super(...arguments);
    this.label = new AutoSizedLabel();
    this.secondaryLabel = new AutoSizedSecondaryLabel();
...
var TreemapNode = class extends import_ag_charts_community162._ModuleSupport.HierarchyNode {
  constructor() {
    super(...arguments);
...
var DistantGroup = class extends import_ag_charts_community162._ModuleSupport.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends import_ag_charts_community162._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  groupTitleHeight(node, bbox) {
    ...
    if (labelValue == null) {
      ...
      const { height: fontHeight } = (0, import_ag_charts_core60.cachedTextMeasurer)(font).measureLines(labelValue);
  ...
  applyGap(innerBox, childBox, allLeafNodes) {
    ...
    for (const side of sides) {
      if (!(0, import_ag_charts_core60.isNumberEqual)(innerBounds[side], childBounds[side])) {
  ...
  getItemStyle(nodeDatum, isLeaf, isHighlight) {
    ...
    const baseStyle = mergeDefaults20(highlightStyle, properties.getStyle(isLeaf, fills, strokes, index));
    ...
    if (itemStyler != null && nodeDatum != null) {
      ...
      if (overrides) {
        style = mergeDefaults20(overrides, style);
      }
    }
    return style;
  }
  ...
  updateNodes() {
    ...
    this.rootNode?.walk((node) => {
      ...
      node.labelValue = (0, import_ag_charts_core60.toPlainText)(labelValue);
      node.secondaryLabelValue = (0, import_ag_charts_core60.toPlainText)(secondaryLabelValue);
    });
    const { width, height } = seriesRect;
    ...
    this.rootNode?.walk((node) => {
      ...
      if (children.length === 0) {
        ...
        const text = (0, import_ag_charts_core60.wrapText)(labelValue, {
        ...
        node.label = {
          ...
          lineHeight: (0, import_ag_charts_core60.calcLineHeight)(group.label.fontSize),
          fontStyle,
          fontFamily,
          fontWeight,
          color: color6,
    ...
    const highlightedDatum = this.ctx.highlightManager?.getActiveHighlight();
    for (const text of this.labelSelection.selectByClass(Text8)) {
      const datum = text.closestDatum();
  ...
  getTooltipContent(datumIndex) {
    ...
    if (import_ag_charts_community162._ModuleSupport.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs23, treemapSeriesThemeableOptionsDef, without: without9 } = import_ag_charts_community163._ModuleSupport;
var treemapSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core61.required)((0, import_ag_charts_core61.constant)("treemap")),
  labelKey: import_ag_charts_core61.string,
  secondaryLabelKey: import_ag_charts_core61.string,
  childrenKey: import_ag_charts_core61.string,
  sizeKey: import_ag_charts_core61.string,
  colorKey: import_ag_charts_core61.string,
  sizeName: import_ag_charts_core61.string,
  colorName: import_ag_charts_core61.string
};
treemapSeriesOptionsDef.undocumentedGroupFills = (0, import_ag_charts_core61.undocumented)((0, import_ag_charts_core61.arrayOf)(import_ag_charts_core61.color));
treemapSeriesOptionsDef.undocumentedGroupStrokes = (0, import_ag_charts_core61.undocumented)((0, import_ag_charts_core61.arrayOf)(import_ag_charts_core61.color));

// packages/ag-charts-enterprise/src/series/treemap/treemapModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO3 } = import_ag_charts_community164._ModuleSupport;
var TreemapModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
        ...
        $applyCycle: [
          ...
          { $palette: "fills" },
          {
            $applySwitch: [
              { $path: ["/type", void 0, { $value: "$1" }] },
              { $value: "$1" },
              ["gradient", import_ag_charts_community164._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS],
              ["pattern", import_ag_charts_community164._ModuleSupport.FILL_PATTERN_DEFAULTS],
              ["image", import_ag_charts_community164._ModuleSupport.FILL_IMAGE_DEFAULTS]
            ]
          }
        ]
      },
      ...
      group: {
        label: {
          ...import_ag_charts_community164._ModuleSupport.LABEL_BOXING_DEFAULTS,
          enabled: true,
          color: { $ref: "textColor" },
          fontStyle: void 0,
          fontWeight: { $ref: "fontWeight" },
    ...
    gradientLegend: {
      enabled: true,
      ...import_ag_charts_community164._ModuleSupport.LEGEND_CONTAINER_THEME
    }
  }
};
...
// packages/ag-charts-enterprise/src/main-modules.ts
var ModuleRegistry = import_ag_charts_community165._ModuleSupport.ModuleRegistry;
