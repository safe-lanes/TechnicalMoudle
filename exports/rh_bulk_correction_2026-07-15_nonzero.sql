-- Running Hours bulk correction — vessel b89759ad-378b-4cec-af80-9cafd44853c9
  -- Source: components_export_2026-07-15 (10 MASTER components with non-zero RH; zero-RH masters excluded; their INHERITED children updated via cascade)
  -- Replicates the app's updateMasterRunningHours() transaction exactly.
  -- Run in ONE transaction. Verify the sanity check (must return 10) before COMMIT.
  ...
  -- SANITY CHECK: must return 10. If not, ROLLBACK and investigate.
  ...
  -- Final verification before COMMIT (expect 10 masters + their 248 children):
