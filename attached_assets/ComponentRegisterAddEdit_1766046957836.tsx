      ...
      <div className="bg-sky-500 px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            data-testid="button-add-new-component"
          >
            <Plus className="h-4 w-4 mr-1" />
            {isEditMode ? "New Component" : "Clear Form"}
          </Button>
          <Button
            variant="outline"
            size="sm"
      ...
      <div className="bg-white border-b px-6 py-2 flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Select value={criticalityFilter} onValueChange={setCriticalityFilter}>
            <SelectTrigger className="w-24 h-8" data-testid="select-criticality-filter">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        >
          {isSaving ? "Saving..." : isEditMode ? "Save Changes" : "Add Component"}
        </Button>
      </div>
          ...
          <div className="max-w-5xl">
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div>
                      <label className="text-xs font-medium text-gray-600 mb-1 block">Parent Component Code</label>
                      <Input
                    ...
                    <div>
                      <label className="text-xs font-medium text-gray-600 mb-1 block">Component Code</label>
                      <Input
                        value={componentData.componentCode}
                        onChange={(e) => handleFieldChange('componentCode', e.target.value)}
                        className="h-8 text-sm"
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    <div>
                      <label className="text-xs font-medium text-gray-600 mb-1 block">Component Name</label>
                      <Input
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div>
                      <label className="text-xs font-medium text-gray-600 mb-1 block">Equipment / System Department</label>
                      <select
              ...
              <div>
                  ...
                  <table className="w-full border-collapse" data-testid="table-running-hours">
                    ...
                    <tbody>
                      <tr className="bg-white hover:bg-gray-50">
                        <td data-marker="B7.B.RHT.V" className="px-4 py-3 text-sm border border-gray-200" data-testid="select-rh-counter-type">
                          <select
                            value={(componentData as any).rhCounterType || "NONE"}
                            onChange={(e) => handleFieldChange('rhCounterType', e.target.value)}
                            className={`h-8 w-full text-sm px-2 border rounded ${
                              (componentData as any).rhCounterType === 'MASTER' 
                                ? 'bg-blue-100 text-blue-800 border-blue-200' 
                                : (componentData as any).rhCounterType === 'INHERITED'
                                ? 'bg-purple-100 text-purple-800 border-purple-200'
                                : 'bg-gray-100 text-gray-600 border-gray-200'
                            }`}
                          >
                            <option value="NONE">None</option>
                            <option value="MASTER">Master (Self)</option>
                            <option value="INHERITED">Inherited</option>
                          </select>
                        </td>
                        <td data-marker="B7.B.RHS.V" className="px-4 py-3 text-sm border border-gray-200" data-testid="input-rh-counter-source">
                          <Input
                            value={(componentData as any).rhCounterSource || ((componentData as any).rhCounterType === 'MASTER' ? 'Self' : '')}
                            onChange={(e) => handleFieldChange('rhCounterSource', e.target.value)}
                            className="h-8 text-sm"
                            placeholder={(componentData as any).rhCounterType === 'MASTER' ? 'Self' : (componentData as any).rhCounterType === 'INHERITED' ? 'Parent Component' : '—'}
                            readOnly={(componentData as any).rhCounterType === 'MASTER'}
                          />
                        </td>
                        <td data-marker="B7.B.3" className="px-4 py-3 text-sm font-semibold border border-gray-200" data-testid="text-running-hours">
                          {(componentData as any).rhCounterType === 'MASTER' || (componentData as any).rhCounterType === 'INHERITED' ? (
                            <span className={(componentData as any).rhCounterType === 'INHERITED' ? 'text-purple-700' : 'text-gray-900'}>
                              {componentData.runningHours || '0'}
                            </span>
                          ) : (
                            <span className="text-gray-400">{componentData.runningHours || '—'}</span>
                          )}
                        </td>
                        <td data-marker="B7.B.6" className="px-4 py-3 text-sm border border-gray-200" data-testid="input-last-updated">
                          <Input
                            type="date"
                            value={(componentData as any).lastUpdated || ""}
                ...
                {(componentData as any).rhCounterType === 'INHERITED' && (
                  <p data-marker="B7.B.HELPER" className="text-xs text-gray-500 mt-2 italic">
