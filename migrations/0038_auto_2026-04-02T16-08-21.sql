...
ALTER TABLE "ship_surveys_master" ADD COLUMN "is_sync" boolean DEFAULT false;--> statement-breakpoint
...
ALTER TABLE "vessel_certificate_applicability" ADD COLUMN "is_sync" boolean DEFAULT false;--> statement-breakpoint
