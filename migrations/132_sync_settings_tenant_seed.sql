...
--
-- Phase 4a (additive plumbing — NO behavior change):
--   * domain                  — the ship's SAILERP-verified tenant domain (X-Sync-Domain
--                               source in 4b). Seeded at provisioning import from the
--                               client-forwarded AuthContext.domain.
...
VALUES
  (gen_random_uuid()::text, 'domain', '', 'text', 'Ship tenant domain (SAILERP-verified); multi-tenant X-Sync-Domain source. Empty on shore.', true),
