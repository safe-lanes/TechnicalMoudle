-- 155: rotational_items → pure master table (Task #366).
--
-- Migration 152 was amended in place (table never deployed to production) so FRESH
...
--
-- Idempotent: safe to re-run; a complete no-op on databases created from the amended 152.
