# Build R5 of the Recent Updates note from the revision that is ACTUALLY INDEXED in the candidate set kb-pilot-c
...
OUT = os.path.join(HERE, "R5", "Technical - Recent Updates & Changed Behaviours (Operational) Notes.docx")
