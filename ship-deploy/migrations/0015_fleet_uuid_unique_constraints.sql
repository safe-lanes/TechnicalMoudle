...
CREATE UNIQUE INDEX IF NOT EXISTS "idx_fleet_components_uuid" ON "fleet_components" ("fleet_components_uuid");

DROP INDEX IF EXISTS "idx_fleet_jobs_uuid";
CREATE UNIQUE INDEX IF NOT EXISTS "idx_fleet_jobs_uuid" ON "fleet_jobs" ("fleet_jobs_uuid");
