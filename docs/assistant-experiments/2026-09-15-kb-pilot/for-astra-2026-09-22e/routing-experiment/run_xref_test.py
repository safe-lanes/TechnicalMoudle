...
#   repaired_c  g4  kb-xref-c   adapted steps only in the text; the verbatim source quote lives in chunk
#                               metadata (audit/citation) and never enters the model's context.
#                               Third run is executed INSIDE g4, so "localhost" is repaired_c.
