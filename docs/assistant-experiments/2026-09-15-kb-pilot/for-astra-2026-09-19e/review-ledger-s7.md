# Review ledger — S7 paired run (v3, 19-Sep)
...
- **F1**: review population 1255 occurrences · risk categories 123, **123 read, 0 unread** · total read on this arm **151**
- **F0**: review population 1212 occurrences · risk categories 112, **112 read, 0 unread** · total read on this arm **130**
- **Both arms**: 281 verdicts recorded of 2467 occurrences in the population.

**Still not read, and therefore NOT verified:** every occurrence without a READ verdict — 1203 machine-UNRESOLVED and 983 machine-auto-supported across both arms. The wider review is incomplete; this is open item C4.
...
- **evidence:** The Lesson Learnt User Manual_Vessel_R0 (p.7), section 2 Discussion Record, WAS supplied as excerpt 2, and the answer cites it. The words 'Lesson Learnt' appear in that excerpt's document/section header.
...
### SUPPORTED — 1 occurrence(s), arm(s) F1
- **claim (representative):** No specific role or office-generation switch is required; normal sign-in and vessel access still apply.
...
### SUPPORTED — 1 occurrence(s), arm(s) F0
- **claim (representative):** The role and switch details are from draft, code-derived guidance verified against application revision cf5241ad6; the operational update also states the Sail Admin and switch requirements.
- **ids:** `generated/6/F0/r2/c17`
- **evidence:** The KB provenance note names revision cf5241ad6 verbatim in the supplied text.

### SUPPORTED — 1 occurrence(s), arm(s) F0
- **claim (representative):** A separate supported process is importing a JSON file: inspection and observation details—including Positive and LAE findings—are populated automatically, while any additional supporting attachments must be uploaded manually.
...
### SUPPORTED — 1 occurrence(s), arm(s) F0
- **claim (representative):** These categories are available in the Store sub-module for both Office and Vessel users.
...
### SUPPORTED — 1 occurrence(s), arm(s) F0
- **claim (representative):** The draft code-derived guidance is broader than the published June manuals: the manuals describe the on-demand and unplanned procedures, while the draft guidance also describes automatic ship generation and office Generate Now, and adds the office co
