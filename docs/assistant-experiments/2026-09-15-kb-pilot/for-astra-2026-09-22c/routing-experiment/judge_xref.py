...
PROVENANCE = re.compile(r"(manual|documentation)\s+(notes|states|says|confirms|indicates|does not verify|cannot verify)"
                        r"[^.]{0,140}(verif|screen details|not confirmed|unverified|not established)", re.I)
