# Citation review — SCREENING PLUS PARTIAL REVIEW (superseded by review-ledger-s7.md)

> **Corrected 19-Sep, after review.** The original title said "Completed citation review"; it was not complete.
> This file is a **screening pass plus a partial review**: it read the claims that fell below a coverage
> threshold and left the rest unread. It also stated "three unsupported claims" without qualification, and its
> Section A listed 8 rows covering **9** occurrences. The corrected statement is **"three unsupported claims
> identified among those reviewed"**, and of those only **two** were in the flagged set — the third
> (`hist-1` r2) sat in the partial band and was folded in without having been flagged. Unread claims are **not**
> verified. The full ledger with stable identifiers, occurrence counts and recorded verdicts is
> `review-ledger-s7.md`.
...
### A. Supported — the metric under-scored them; the text is there verbatim (8 grouped findings, **9 occurrences**: `prep-3` contributes r2 and r3)
...
### C. UNSUPPORTED — 3 claims identified among those reviewed (2 of them in the flagged set; `hist-1` r2 was in the partial band), all one root cause
...
- It establishes that, among the claims it reviewed, **three are unsupported by the text supplied for the
  question asked**, and all three trace to one open defect. It establishes nothing about the claims it did not
  read.
