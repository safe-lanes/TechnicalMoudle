...
# switching screens — whether Stores inventory is maintained from the Spares screen is UNRESOLVED
# and must not be asserted here. So each hit is
...
def main() -> None:
    ...
    print("screens. Whether Stores inventory is maintained from the Spares screen is UNRESOLVED.")
    print("Each entry needs a")
